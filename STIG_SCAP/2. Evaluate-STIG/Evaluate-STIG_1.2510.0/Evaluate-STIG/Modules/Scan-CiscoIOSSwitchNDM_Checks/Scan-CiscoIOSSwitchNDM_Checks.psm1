...
Function Get-V220587 {
    ...
    IF ($AllUsers) {
        $UserLine = (-Split $AllUsers[0])
        $PrivilegeIndex = -1

        # Find the index of "privilege" keyword
        FOR ($i = 0; $i -lt $UserLine.Length; $i++) {
            IF ($UserLine[$i] -eq "privilege") {
                $PrivilegeIndex = $i + 1
                break
            }
        }

        # Check if privilege level exists and is a valid number
        IF ($PrivilegeIndex -gt 0 -and $PrivilegeIndex -lt $UserLine.Length -and $UserLine[$PrivilegeIndex] -match '^\d+$') {
            [INT]$PrivLvl = [INT]$UserLine[$PrivilegeIndex]
            IF (!($PrivLvl -eq "15")) {
                $NR = $True
            ...
            # No privilege level found or invalid format
            $NR = $True
            $FindingDetails += "No valid privilege level found for local account." | Out-String
            $FindingDetails += "Line: $($AllUsers[0])" | Out-String
            $FindingDetails += "" | Out-String
        }
    }
    ...
    IF ($SnmpServerConfig) {
        ...
        IF ($SnmpServerConfig | Select-String -Pattern "^snmp-server view .*") {
            ...
            ForEach ($SnmpServerView in $SnmpServerViews) {
                $MatchString = ($SnmpServerView.ToString().Split([char[]]"") | Select-Object -First 3) -join " "
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhLpZ0M61aulhb
# VpWL4AKgmkXgcR3vHXF39ZkZNj/hVKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCCTVlYSKF2aMw9MtDYjpoAlZ8gQzKEwuGrRDZPLX7iJ6jANBgkqhkiG9w0BAQEF
# AASCAQBS0gjRb46DStpvUNkuv3RwBXDEsOvhUlc/UBELHWFvDYlEvOf0ZzVBL6Qt
# dTpOIRb2vpT9UanS/d+c9kZjVUriLqBNrwwrZz/lwIMfJ+tT7n07fUvWcfWaHB3b
# 9dlZ4XGl4LnL91gHr1Z/pQIHMIZa+D02YVkFtrJsaSSfAeliAVItTSTAz91St9/W
# yBzLR+0UheYvy0BSr2Sp40ks4p9G0PBsSFH9pXOGNKqFxZ3B25zKtzNvgprwUasX
# HYFPKdaSRYD7CZA9Q5hLdIl59GUwK+FTDCMwz9kcZzupoK9W2gk1ruqSPQp0qy3r
# 2OSx0pfBK8Hi4+diSj9YplNKah5QoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEyNFowLwYJKoZIhvcNAQkEMSIEIJyCblM5ZWKR9Pl1R88L5LITopzZ
# C6dl5mu/y2k4S+K/MA0GCSqGSIb3DQEBAQUABIICAMYegH0XTBVyIMWi7gUMbaNy
# Fzol2yYqAikENOw5xUtgmt2+0iShCW8S+eTTHJ8sW7FUD6A5OMMuCjN0uSZJay7Y
# Vckvx74kUuI6BWRYE/F/cIvf30i9zNxyGXiTTD4ZlXqNuj2nXsFvcJ2ctpanlpb8
# S2mtsWFj6Ny5mncZnbUK7IQKywK+2aLzIuMySM2FVxiWA9oeJVznWa6AR6insHeL
# PJAaQlGwm84fK0GdhEKGqcuuKgHuaXhT/Js32WOHbSErN+Dco+4LNwzVzgwjOf7G
# ytmgcmH+DrCEu9FmsmH67tU25hiHDCYxJOs2QVvIJ8+2ho7SMYrse2M73rXQL+Pt
# 7f2vMaMtZ8aKZvorTUZ10cxKgbUFGXf6iEUJVTtp9SW64HalTC2gE1iTvdPOykCs
# z4Dj/DeSLwiqm34AsMs6bbKSocm2CQKALmqbNfziiT/Ji8KmudNFgu0JZhKvizro
# fi6P58l4GKW5o2/XJGDWYeE9gdsDrR7eT7cglxLfIDfwZBoqJfm7AWxCMUt/pvo3
# h76OMUHtp4BBDV9e9hrPpu+nUKinLPvsCrldFd1B5CYIQjP4hTC4FoHS8nLrWDBN
# E3BvCxF643grI+SLij5ljKFySMTgBhR0r8cJFOU/uQmk8rsqs2UrOzuBqPlb+Yc0
# ZoPiigUXqAogxbw6nmUE
