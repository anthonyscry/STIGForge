...
Function Get-V228562 {
    ...
    .DESCRIPTION
        Vuln ID    : V-228562
        STIG ID    : DTOO401
        Rule ID    : SV-228562r1000185_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Microsoft Office running on the system must be a supported version.
        DiscussMD5 : C16982369307FA98DA87A62B16B8CADD
        CheckMD5   : 26515F48E4D35CC46CAB453A9C88C932
    ...
    If (Test-IsMSOfficeInstalled -Version $AppVer -Component $AppName) {
        $Status = "Open"
        $FindingDetails += "Microsoft Office $($AppVer) is installed. [finding]"
    }
    Else {
        $Status = "NotAFinding"
        $FindingDetails += "Microsoft Office $($AppVer) is not installed."
    }
    #---=== End Custom Code ===---#
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCrHd9rNDaufEX8
# RZl1gRUjbzWI2vNvMJ5ZgaNL8haH56CCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCCtjLGO3z8pQUqn979P2C2tKRBcSLtJ2Cv+peelQ+IGKjANBgkqhkiG9w0BAQEF
# AASCAQAx36fpi7HJ7g3VzcO2a+3YyJR2q6M25yVqnXGmzwHc/u/S/KVZ3vE7ppDR
# 95ZXDGU/0ws5+2T40+jTfOsRrBHEf/tcVvCvZ7iXYE8efHMI0d1Cw51jyT2ZlGyr
# bJmkQnUxvA9dzMreA2uk99R+y6b6xnm8/X7XRzNgqzDbnPdHO3Xj2ZQV2e4e6iIr
# 87IZMVRkPn5sEivvPPk2NKIQcBnpUNnqPyfJs5KYoGVqNYe5uAr+x++E63Y9MYiq
# oZa6RwHyCwZ5kXpaFqQSjPfJQIlqdIk3C57/tFf+OFV7cifyRqqNLHzpWgAc96KF
# XFf3NNAyPcsgvJQUHqCatZK3+Nd6oYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTE1MFowLwYJKoZIhvcNAQkEMSIEIIwIXqSLxcu2YHEcKjVLVxz+g2G/
# 6abCoGL6TmLrFT7lMA0GCSqGSIb3DQEBAQUABIICAIx3PDpuOVdOJh+Lywy6iHrU
# 6mY/rkN5+iv5T/Jq7wjBfYzHTzX7m4NdHuHtv0HsvdJfam3NbPFHD1brXTFlVyfB
# +NJFCxqFl+kfBv5S8jldwuhRiJti6vRP09+2+Q+TqK9J9ivhJF0q1KrDmMYmZBMg
# j8NeisR3ZSlg+LqFd3XrBprGUh/kkJKzFT2zhvOLcoI9W79xzB6A5qSQamWrwlXF
# oIO8kDr7OrZzpJg8Jo0s0BWUBKaShDW5OUlgzH6S3TOOxKiJS0+yh1VXc4M1KV1J
# ueGSCH0BoNcyg0R2PBSdbBG1o3a1wlf/762GYpvVhpmx97MH1R9L0hR/eT9Bahbi
# xK4gxpW12zyjKmW4e8vlQusTtSFNya5QqNTeLZduJ5hcol3ZLZJYwyQCdpSB98As
# SZaT3g8VsZ5kyZhcu+RmKAi/L4SV/RIXHPBEzf/9LmdiSnWp+goOKHRPdQyRHgKx
# sGD/7yAv+KePrIj5+AKCif2+2M7xJidQlSTHrtheRtuSnIi55qa/uIBAzNyh1amD
# 9zc985PzMach7Jv3X5qOtlqHr3/DmdwShHHPgKxFrnste1hWBCgPbdTgHRoEKH4x
# 16u3VVaT6IkXlS4UwBZ3t7M1XAFaPvYCrGJ2V/1UnbdQSZf4A9G5YONjX0MTcsiv
# sYqJx2tCdJkY8qALgiRb
