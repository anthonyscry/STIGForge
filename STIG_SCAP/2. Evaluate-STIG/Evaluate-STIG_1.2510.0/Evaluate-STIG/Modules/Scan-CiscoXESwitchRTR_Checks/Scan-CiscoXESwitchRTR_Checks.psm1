...
Function Get-V220986 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-220986r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221007 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221007r1117241_rule
        CCI ID     : CCI-001109
...
Function Get-V221008 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221008r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221023 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221023r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221024 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221024r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221025 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221025r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221026 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221026r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221028 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221028r1117236_rule
        CCI ID     : CCI-000032
...
Function Get-V221029 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221029r1117236_rule
        CCI ID     : CCI-000032
...
Function Get-V221053 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221053r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221054 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221054r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221055 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221055r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221057 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221057r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221058 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221058r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V221066 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221066r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221067 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221067r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V221068 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221068r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V237766 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-237766r1132545_rule
        CCI ID     : CCI-002403
        ...
        CheckMD5   : DAB55149BD6D8E568DEF0D2358C2876B
        FixMD5     : 763F5DA2D55139E866567B77E2714D68
    #>
    ...
    #---=== Begin Custom Code ===---#
    $ShowRunningConfig | Out-File C:\CraneDev\Test\showrun.txt
    $Interfaces = $ShowRunningConfig | Select-String -Pattern "^interface"
    $AccessLists = $ShowRunningConfig | Select-String -Pattern "^ipv6 access-list"
    $CompliantAcls = @()
    $CompliantInterfaces = @()
...
Function Get-V237772 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-237772r1135079_rule
        CCI ID     : CCI-002403
        ...
        CheckMD5   : 069E3D175FE87E22F1BDD2E259D4F6DF
        FixMD5     : FF7F51AFA3733A397CE6B6E19FAFDC99
    #>
...
Function Get-V237774 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-237774r1135080_rule
        CCI ID     : CCI-002403
        ...
        CheckMD5   : 26EA3612FB2790251DB79B2BA97B41E7
        FixMD5     : C2EEF9E13F26D338E7D7D22C9FC85DD6
    #>
...
Function Get-V237776 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-237776r1132549_rule
        CCI ID     : CCI-002403
        ...
        CheckMD5   : DAE8C003AE70698FB125172B63712ECA
        FixMD5     : FF7F51AFA3733A397CE6B6E19FAFDC99
    #>
...
Function Get-V237778 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-237778r1132550_rule
        CCI ID     : CCI-002403
        ...
        CheckMD5   : 5B835791054CCAA08F4E95FB7B1F38CF
        FixMD5     : DD3787FF39518D5ACB60E02A9F718226
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0n6E92xFB9s6v
# VF4lP63yN4gofdZIc2Ga10SRS5nWEaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCCZO0d8IOMqEEzdTEh02+xdU2oy6tbNFh5PsSrR4N9VnDANBgkqhkiG9w0BAQEF
# AASCAQBFP01UyNs35eDEqf1LtbRt4eruANnbloptHEbfuvBaC/irB40OMSMKpuJC
