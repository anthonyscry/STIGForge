...
Function Get-V222931 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222931r1117167_rule
...
Function Get-V222932 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222932r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-AS-000024
...
Function Get-V222933 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222933r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-AS-000024
...
Function Get-V222934 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222934r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-AS-000024
...
Function Get-V222935 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222935r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-AS-000024
...
Function Get-V222969 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222969r1117171_rule
        CCI ID     : CCI-001082
...
Function Get-V222970 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222970r1117171_rule
        CCI ID     : CCI-001082
        Rule Name  : SRG-APP-000211-AS-000146
...
Function Get-V222971 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-222971r1136930_rule
        CCI ID     : CCI-001184
        ...
        DiscussMD5 : 4EA0C3B80091EFB98A06D39CFBE6F166
        CheckMD5   : 7C47127E1FC98439A058DC7AFC8532A4
        FixMD5     : 5D11D3263B0490DBAEBA183DAAAC5556
    #>
        ...
        if ($null -ne $XmlObject) {
            ...
            if (($Elements | Measure-Object).count -eq 0) {
                ...
                foreach ($element in $Elements) {
                    ...
                    if ($null -eq $($element.certificationVerification) -or $($element.certificationVerification) -eq "") {
                        $CertificationVerificationValue = "Not defined"
                    }
                    else {
                        $certificationVerificationAuthValue = $($element.certificationVerification)
                    }
                    $FindingDetails += "CertificationVerification:`n`t$certificationVerificationAuthValue" | Out-String
                    $FindingDetails += "" | Out-String
                }
            }
        }
...
Function Get-V223003 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-223003r1135503_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516-AS-000237
        Rule Title : RECYCLE_FACADES must be set to true.
        DiscussMD5 : 8261D5A7C5A203477E26B0301EC004D9
        CheckMD5   : 45D9B152D0D95EEBF9C8B757FA2F87F4
        FixMD5     : CE3612B0E2E93942B24CF0537A502374
    #>
...
Function Get-V223004 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-223004r1135506_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516-AS-000237
        Rule Title : ALLOW_BACKSLASH must be set to false.
        DiscussMD5 : 4F0975FC84FB9DEEB5F348770A823D45
        CheckMD5   : FCB868F3095055A7F2D8E3DA992FDC67
        FixMD5     : FD01475CC9563DC5EE13B6DDF2F32AC1
    #>
...
Function Get-V223005 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-223005r1135509_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516-AS-000237
        Rule Title : ENFORCE_ENCODING_IN_GET_WRITER must be set to true.
        DiscussMD5 : 050ECC8D7EF33090725EE0A2DFEA0632
        CheckMD5   : 098B6FDD0032E0DE8EEDAF61756E0865
        FixMD5     : 4718B27512248B770D649ADC0DB7ED41
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABC