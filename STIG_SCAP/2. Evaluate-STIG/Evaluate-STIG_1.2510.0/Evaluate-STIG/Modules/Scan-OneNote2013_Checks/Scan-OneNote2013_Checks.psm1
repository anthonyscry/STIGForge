...
Function Get-V242565 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242565
        STIG ID    : DTOO104
        Rule ID    : SV-242565r961092_rule
        CCI ID     : CCI-001170
...
Function Get-V242566 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242566
        STIG ID    : DTOO111
        Rule ID    : SV-242566r960921_rule
        CCI ID     : CCI-001695
...
Function Get-V242567 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242567
        STIG ID    : DTOO117
        Rule ID    : SV-242567r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242568 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242568
        STIG ID    : DTOO123
        Rule ID    : SV-242568r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242569 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242569
        STIG ID    : DTOO124
        Rule ID    : SV-242569r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
...
Function Get-V242570 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242570
        STIG ID    : DTOO126
        Rule ID    : SV-242570r961086_rule
        CCI ID     : CCI-001662
...
Function Get-V242571 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242571
        STIG ID    : DTOO129
        Rule ID    : SV-242571r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242572 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242572
        STIG ID    : DTOO132
        Rule ID    : SV-242572r961089_rule
        CCI ID     : CCI-001169
...
Function Get-V242573 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242573
        STIG ID    : DTOO209
        Rule ID    : SV-242573r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
...
Function Get-V242574 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242574
        STIG ID    : DTOO211
        Rule ID    : SV-242574r961779_rule
        CCI ID     : CCI-002460
...
Function Get-V270895 {
    <#
    .DESCRIPTION
        Vuln ID    : V-270895
        STIG ID    : DTOO999-OneNote13
        Rule ID    : SV-270895r1055866_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of OneNote running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : B1F9E6661F0C07FD7FF58E8777A66D51
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAAiDXbCbWuXIXv
# yj6wRUiFk6J/xYslM2ealr+9o8oKzaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCAk7of9ccVlSIHtkTTrZHhUbaR38p2mzSEDzkNHyVt/tDANBgkqhkiG9w0BAQEF
# AASCAQAJBJ+pSPFsuZMeFIqKKRWyfMoTiSmIpsRJ+ArL3TvB4m8To7DrVOIxw6Sz
# g47Gbi8jLyT6OP6n5jba9Sle0/OUr3DKvzrg0CcX9lA0nk81VYAyuvkhQ/EDI7Py
# K2AvDO6aNHFQi3L2cB2xAFLdQinZJUx09zmfH8JGNs9aB6lz+PHZdb+u3VpWzppt
# wtrz4K7ExtJKUCnbkDdjesC5HumNN1n9rx0UmKZnwYlSBXP2drm9B9sIcLEyMK10
# jC+glBb0ezmx2G4bkn5cN/qLn7ljdnSpd8IqhXWKrnc87S0bDVy9cFbWwGGNdHcc
# lvFN9Vahd8nsvgWDK96/orcCJD+UoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTE1MlowLwYJKoZIhvcNAQkEMSIEIGJbFTsZz5CiKvX86pijI/TC549I
# yx1qxGDdCOB8BAYGMA0GCSqGSIb3DQEBAQUABIICAJu3qIJxv3vjMs/DfU6iXUui
# TcnCXy1k8FeoCCsCWalQZDF/KOZcoGqmdvSvznjiNfQsS9xrw0fZD0AVC4UjVKtS
# uiXFsB5DZLi/WCvVKoOKZeKbi8vPwLwxJCfiZ75TYIpbktCqL4bIjTXlA6D66uzf
# EkoYTCvvNJYgfMl18sdgCAgDyFoeeiWS+X6rfaosdiSY/jnREvYoi2afG9PnFVeb
# 5ai9UNu8ol97mKl1t6WkCUKwNMDAniWYyBNlt3HRQhq7XLLBJbcShlHGvzYZ4B2k
# +6GNmAuAbnPjHCenKSyJ7of3+WFQC3SeCMc6i+Zwy56c3HSytoiyG2QzlORGTkes
# s0i3s3ELFz6K6Weqh4XFRIwto486Fe+ku9sprbxrHPv+XNJoNTpRkZSrO77fTh4q
# CXCTzRBTGgHbelBoy7o/MP5L9INVh61hesaLic+k7pgPlDbBYESGHWDXkuv1YxhB
# J1OoecIdMTNlGvQYzaifklN6Jv6vE5SLt7EbQTGjUG+5y0muUyoW9L5dgAp2YioR
# iS0rpEGIlk/iu5jb3sE+Aygq6IXMsCNc7vwX0LcGxVn1SdGElhjEnASqrDoo50cj
# UfjmZhtikIDQLJV6sd5ptn/0IIJT9nofDi/WOS3hPK9hdNW3mqxZ3mk4mUxQ+aeg
# V4HkoajC4vPMHUXLXXxC
