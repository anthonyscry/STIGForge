...
Function Get-V242814 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242814
        STIG ID    : DTOO104
        Rule ID    : SV-242814r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        Rule Title : Disabling of user name and password syntax from being used in URLs must be enforced.
        DiscussMD5 : BBCA3501E2F44FC01CDFB61AEF44F13D
        CheckMD5   : E1998B06FF3743F10D747DEBB11E3CA6
        FixMD5     : 0719E0E869FA578F1B6B648414CAF9D2
    #>
...
Function Get-V242815 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242815
        STIG ID    : DTOO111
        Rule ID    : SV-242815r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : The Internet Explorer Bind to Object functionality must be enabled.
        DiscussMD5 : 757B4ABDE9BBFA029D00C4A83284B7F6
        CheckMD5   : 66C2C84089B26299DEF3B7CEE9ADBA56
        FixMD5     : E725E8086628C493FAA5C29C90157CFB
    #>
...
Function Get-V242816 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242816
        STIG ID    : DTOO117
        Rule ID    : SV-242816r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        ...
        CheckMD5   : 679A3CDDBF6D21F603D0F19ECB6619EA
        FixMD5     : 89B525B14988788D1AC0D0D2D0A001E0
    #>
...
Function Get-V242817 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242817
        STIG ID    : DTOO123
        Rule ID    : SV-242817r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        Rule Title : Navigation to URLs embedded in Office products must be blocked.
        DiscussMD5 : 15A059C11FCE317B8DD12BF6ACFF5061
        CheckMD5   : E52BB15EF0F3D2C01288B8E486456150
        FixMD5     : 02F5354C38BF2F861CE812B573788843
    #>
...
Function Get-V242818 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242818
        STIG ID    : DTOO124
        Rule ID    : SV-242818r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Scripted Window Security must be enforced.
        DiscussMD5 : 5B15E95EFB4F43B2E61DD1BDFC47FBA9
        CheckMD5   : 80FB1052B4AC5EBF41FBA6A3D30A24E1
        FixMD5     : D830FC08951CADCA35FFDE56F7D7D192
    #>
...
Function Get-V242819 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242819
        STIG ID    : DTOO126
        Rule ID    : SV-242819r961086_rule
        CCI ID     : CCI-001662
        ...
        CheckMD5   : 13158C983CB9E164E92F031BD53A9536
        FixMD5     : 842B7FAF1DE55744580E67318293AB41
    #>
...
Function Get-V242820 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242820
        STIG ID    : DTOO127
        Rule ID    : SV-242820r960954_rule
        CCI ID     : CCI-001749
        ...
        CheckMD5   : 015549EF3DFEBB0C6B660F97AE7030CD
        FixMD5     : BD6DDE538043007D1DE42CEFC495EC9D
    #>
...
Function Get-V242821 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242821
        STIG ID    : DTOO129
        Rule ID    : SV-242821r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        Rule Title : Links that invoke instances of IE from within an Office product must be blocked.
        DiscussMD5 : 0B8A32210D634B335FABA151BAC75E46
        CheckMD5   : F95DBDB09EC4CBCD042BA80EEA8F7C79
        FixMD5     : 8993D134955000BED1C0CDD1809D0218
    #>
...
Function Get-V242822 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242822
        STIG ID    : DTOO131
        Rule ID    : SV-242822r960954_rule
        CCI ID     : CCI-001749
        Rule Name  : SRG-APP-000131
        Rule Title : Trust Bar Notifications for unsigned applications must be disabled.
        DiscussMD5 : BCAD96A3E742343315CF521DEFFBA88A
        CheckMD5   : 5B7D4F16C305E5FBFB16484299CE23FC
        FixMD5     : 28DACA45408F36EFD228BAF9ACBB064A
    #>
...
Function Get-V242823 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242823
        STIG ID    : DTOO132
        Rule ID    : SV-242823r961089_rule
        CCI ID     : CCI-001169
        ...
        CheckMD5   : 140263577F019866047D40ED83592AE5
        FixMD5     : 142EDCE4035A07598213FC53A3C0A8F7
    #>
...
Function Get-V242824 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242824
        STIG ID    : DTOO209
        Rule ID    : SV-242824r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Protection from zone elevation must be enforced.
        DiscussMD5 : 52D56D491DB43FA83C289436F8E31C32
        CheckMD5   : D3946A9015A5740B23EA6F455882CA0B
        FixMD5     : 1271263FEE6095AB2454A7074604DA22
    #>
...
Function Get-V242825 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242825
        STIG ID    : DTOO211
        Rule ID    : SV-242825r961779_rule
        CCI ID     : CCI-002460
        ...
        CheckMD5   : DAB747816B8BD33352A3495B4D1AD433
        FixMD5     : 7B6FC91BE31BF031EEDB52CA9DF45B9D
    #>
...
Function Get-V242826 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242826
        STIG ID    : DTOO304
        Rule ID    : SV-242826r960963_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Warning Bar settings for VBA macros must be configured.
        DiscussMD5 : F243E905FD51F0C1663C52BC1FDB660D
        CheckMD5   : 89189969B4B1F95C657237D8A4B3222E
        FixMD5     : 31D5A5A57F252C3168358E30412EA4C6
    #>
...
Function Get-V265900 {
    <#
    .DESCRIPTION
        Vuln ID    : V-265900
        STIG ID    : DTOO999-Visio13
        Rule ID    : SV-265900r999904_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Visio running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : 972FCC74527D6869E34D440DA253B070
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCATWD0qGu2VmTXF
# tsnurXKMAY/W6xqB3I6Z0jSQw8yupKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCCGfxKBO9i93eguLx/rc3Xl5srJ8yLnr1jCUh3f9DNA4DANBgkqhkiG9w0BAQEF
# AASCAQAYdB10rFdD4qduUojuOfFhMMiL5/zIT9r2L9n//wuHWF0bfryIVFV/ceWM
# GG8Kt6Es5ElZhSLnwa/pX1IPGtfAjJgs8Qk+TEdw0iEXr+h8X9uVbN74K1eZ4iBW
# TOCBerK+Ri072lsz/gTvB1jwORXdOlHluFWGdK8DhXW/6uNgk0lNpxELhNC4yKgS
# wVV6T7VTl4UKKIpKknbTVPcmJbiRYI9/fMSIp2xsYY23hovLQkmrxK2p6oHHkQ7H
# Wl+Kx+osCTjYudMXLD6ffUPiqN9bkz+UFGpiHECbJ6GvevE5Ag7Jl/yN566bBTUg
# 3hpMHzVToyoL9Ra5mZ798Sc3XdeEoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTIyNlowLwYJKoZIhvcNAQkEMSIEIAxICAdcyWATdcmaMgouz961GEkX
# LeGkIRTUjsHkIUncMA0GCSqGSIb3DQEBAQUABIICAFjTlRRESFQu3hjxyLQJoMkS
# JfmQMx1y9XGrrLJQJe89hoNK5DmyOqV89zutSOXK4X780rvPSIsUnawqsEySN7GQ
# LR28M1idqLtq4fiKjxJORyQpEIyL5JNgF46gRvmh3ShkcKrTpei/ZDmEwmgwUffy
# 59MhUzvRjBwdAy2R6KUxdlKmJFUDWi0+40fQfQR2jC7349bZp8n1XT45H7FRDKBr
# hD6Td6cuRkCZv++RyE283bU7rV4Ufpv8X2GsK16waLNwpEvZQxOCxQE4+STp9cHe
# YFhAY5hcaq0KZ+TiQIx5hBmnCMeE1im4j2GwMS+pQfF5LuVuzVCjH3hb1p7iEZnl
# UBhvXbnW2ZIBVW524+qx8VuYig2CPWuv1kKUI+nIScx5VRvdvdMyoJuI65/qrXAb
# TLVs0QMhoDvLWNlsQW8irYbMXjJQDpND5pHQk28OfWKuS6V1nnbE+fUASGEL/S2B
# eJ/EOZ4fGOCTURRpflhL7lnLYxRyW+L60iELyyXM+hTjoIZoiPCgyi5qhP3B54Sm
# OON8fwh4nKAEkHQ7vatxs1Oz8cIP7tFmOT543qq0DoalvHJMbdDKP1FbEETdbzCT
# 9muT5tvZluyBcZrca1fO7UBQnx3wrXtviu5w0EFLdQTgHJ7bYe9oJxYYshO+P38M
# M+6EHEVgz/4wSnGP4X/6
