...
Function Get-V242312 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242312
        STIG ID    : DTOO104
        Rule ID    : SV-242312r961092_rule
        CCI ID     : CCI-001170
        ...
        CheckMD5   : 08C969C5BFE69610D73ADC4D4153B6CD
        FixMD5     : BAD3B09B385DB7039E78F2B8E801CF2A
    #>
...
Function Get-V242313 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242313
        STIG ID    : DTOO111
        Rule ID    : SV-242313r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Enabling IE Bind to Object functionality must be present.
        DiscussMD5 : B293FF32C731BEB1B3C0488463EAF17A
        CheckMD5   : EB940F20DD6A2D2231C9ACC85FDBF3CB
        FixMD5     : 38A6AE302E70C4A98028ACCB73597FD7
    #>
...
Function Get-V242314 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242314
        STIG ID    : DTOO117
        Rule ID    : SV-242314r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        ...
        CheckMD5   : 5E44A6CBB0E9566D2763FA9AA3AF2678
        FixMD5     : DFACE319715994AECE4792D63E5432F1
    #>
...
Function Get-V242315 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242315
        STIG ID    : DTOO123
        Rule ID    : SV-242315r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        Rule Title : Navigation to URLs embedded in Office products must be blocked.
        DiscussMD5 : 15A059C11FCE317B8DD12BF6ACFF5061
        CheckMD5   : 8AC34121F20CB8E7D5D60CEBF62C1719
        FixMD5     : B7700274C5678776341B93307CC53056
    #>
...
Function Get-V242316 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242316
        STIG ID    : DTOO124
        Rule ID    : SV-242316r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Scripted Window Security must be enforced.
        DiscussMD5 : 5B15E95EFB4F43B2E61DD1BDFC47FBA9
        CheckMD5   : 633BB432B85F9382A6BC414DC355A21F
        FixMD5     : 2872C49234BC6CE03EABA10CE3C39D1A
    #>
...
Function Get-V242317 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242317
        STIG ID    : DTOO126
        Rule ID    : SV-242317r961086_rule
        CCI ID     : CCI-001662
        ...
        CheckMD5   : 31DE5B7CB55860DCDF0E4974B940E8FB
        FixMD5     : 3082B7B7C7D688B542ACEC830E1CE547
    #>
...
Function Get-V242318 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242318
        STIG ID    : DTOO127
        Rule ID    : SV-242318r960954_rule
        CCI ID     : CCI-001749
...
Function Get-V242319 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242319
        STIG ID    : DTOO129
        Rule ID    : SV-242319r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        ...
        CheckMD5   : 0112F25A0628B9577BC93218F231024A
        FixMD5     : 4CADE51DBB6D5C65EE764678A4AABEA9
    #>
...
Function Get-V242321 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242321
        STIG ID    : DTOO131
        Rule ID    : SV-242321r960954_rule
        CCI ID     : CCI-001749
        Rule Name  : SRG-APP-000131
...
Function Get-V242322 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242322
        STIG ID    : DTOO132
        Rule ID    : SV-242322r961089_rule
        CCI ID     : CCI-001169
        ...
        CheckMD5   : 997D6F2B2C338871BAE3F510CEA8E5F0
        FixMD5     : 551C4975A4FDA6058FDEACA141832010
    #>
...
Function Get-V242324 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242324
        STIG ID    : DTOO136
        Rule ID    : SV-242324r960963_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : The Save commands default file format must be configured.
        DiscussMD5 : DB3291B7D4B175C58903467D4F9387C6
...
Function Get-V242325 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242325
        STIG ID    : DTOO137
        Rule ID    : SV-242325r961863_rule
        CCI ID     : CCI-000366
...
Function Get-V242326 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242326
        STIG ID    : DTOO209
        Rule ID    : SV-242326r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Protection from zone elevation must be enforced.
        DiscussMD5 : 52D56D491DB43FA83C289436F8E31C32
        CheckMD5   : F5FF846ADE7F77C3EBFE0423026AC528
        FixMD5     : 650A337E2851296F06556383E7307CFD
    #>
...
Function Get-V242327 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242327
        STIG ID    : DTOO211
        Rule ID    : SV-242327r961779_rule
        CCI ID     : CCI-002460
        Rule Name  : SRG-APP-000488
        Rule Title : ActiveX Installs must be configured for proper restriction.
        DiscussMD5 : 6E1A29A00F314CE8B1F1D28CC95B68D2
        CheckMD5   : 7049C2C467F9C276FB132BCC4C30B6A4
        FixMD5     : EAD23CF32551C8DA01A261697441F8F5
    #>
...
Function Get-V265888 {
    <#
    .DESCRIPTION
        Vuln ID    : V-265888
        STIG ID    : DTOO999-Access13
        Rule ID    : SV-265888r999868_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Microsoft Access running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : CE7D45728480DD94885C5CCCA467CAEC
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCr8zySkm+A8Zh2
# ivTB4Oodg8+wvA3Rj/waW0vx8k8yDKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCDoV3/DLnW6M64anJHxXXzBGwB8L4PUyePWw9ueREHC0jANBgkqhkiG9w0BAQEF
# AASCAQA5U0plNZyhGeFKpkqTIFmS6dmBlO64qMAa96rYfbfLnwDVEdyHVoG+5w7f
# IDe/9Bz8i0yPUwzF89LFMI8+W8YQ5X2SqPKCDWe6iEazWpmOgv/njE+C2Gg3scMa
# UYsG5kIJH0IGbcOZBjOnRF9GNbduNRE2Lww3vlv4c3VJIBZzHOHwvwYCl51i5Ae4
# dLajBetWBe9bkvFrmxjN8JliV6CbJxbrCXGXrSs4MilOhljprhWZifJ73b54SFEV
# Ha2y/WXcl6yEhOV3Tvpn9unT/b6kkXkdixyRvqriEi162FAe+aoncCM0J40yR5lV
# vbHN7177r75a/04c2Lsy2u4lisdToYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTExMFowLwYJKoZIhvcNAQkEMSIEIEzoRv+NUjTnR5uYdZMPLT/4YJwV
# lsV2yvR5x2KJrDU9MA0GCSqGSIb3DQEBAQUABIICAADq77JpFluHAWqTuoVbj6dD
# LuPTZQlPjZPECMKXsUVVw6MTH609+ln3XeKOo+AvBGvuR2IM2x5IIwwsE57iwo44
# 0PseTBnzHnd1QAzgYc6o0MoY2Gb2+VTsqquDE0z+q1ECo3FcHgfmqhmYrqM/c1JM
# S7oL0I+JQ3SCA6BDUAz/XwMrS7iOYA/BaCI5+COpsH0UjF/B3m1YpaDn/LQeuOhW
# 94dOJg1ajXS0Mij7aKIkeAnFJPXhMx+wGFmZNS6RWFQPgbOHdZe17xuneYMqQG3u
# rjLgzfZS6W/MAHX/iEziFiUH90V8rJ8tE0tUhLShv+DieE3x3AYh02vv9EjM0F4U
# gfxHgWawcMVyWQP+YZkPrnDTrjzNu9EKozQmj3pRQovmb98gyqozqc5FA+nYwlqk
# 9THctVlcikJ0KvpT9RsdngeHqahhLqeUwbMIJdk8wyXQrz6EwcTnGyQ9rwNGJpqQ
# c1zY8Ny10NC/1480sGpqqXl/bKbgyePkp/u+xXqExDIXqJdnIptrU/OYxmmRAhI1
# icrDdT4+A1czcKkacXKIkUbmg6zTq07xlYnM/TeXRKPAsBikvd+2u6uPorzr3gJz
# F4lO1SiyR/Yre+qOJVaVx9IR/8MYu7gWcWiVQx4tjY6v7jqaFyHK1t+139+YAhTX
# IdEw8B+IhSXJ9W2Lgp46
