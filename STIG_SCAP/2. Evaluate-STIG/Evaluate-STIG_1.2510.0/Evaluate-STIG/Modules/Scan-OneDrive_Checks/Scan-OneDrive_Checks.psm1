...
Function Get-V275978 {
    <#
    .DESCRIPTION
        Vuln ID    : V-275978
        STIG ID    : DTOO999-OneDrive
        Rule ID    : SV-275978r1111822_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of OneDrive running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : 482B3323177CAF9BC7691112D3D9DDC3
    ...
    #---=== Begin Custom Code ===---#
    $Compliant = $true
    $OneDriveVersions = [System.Collections.Generic.List[System.Object]]::new()

    if (Test-Path "$env:ProgramFiles\Microsoft OneDrive\OneDrive.exe") {
        $FileInfo = Get-Item -Path "$env:ProgramFiles\Microsoft OneDrive\OneDrive.exe"
        $NewObj = [PSCustomObject]@{
            FilePath = $FileInfo.FullName
            Version  = $FileInfo.VersionInfo.ProductVersion
        }
        $OneDriveVersions.Add($NewObj)
    }

    if (Test-Path "${env:ProgramFiles(x86)}\Microsoft OneDrive\OneDrive.exe") {
        $FileInfo = Get-Item -Path "${env:ProgramFiles(x86)}\Microsoft OneDrive\OneDrive.exe"
        $NewObj = [PSCustomObject]@{
            FilePath = $FileInfo.FullName
            Version  = $FileInfo.VersionInfo.ProductVersion
        }
    ...
    foreach ($Path in (Get-UsersToEval).LocalPath) {
        if (Test-Path "$($Path)\AppData\Local\Microsoft\OneDrive\OneDrive.exe") {
            $FileInfo = Get-Item -Path "$($Path)\AppData\Local\Microsoft\OneDrive\OneDrive.exe"
            $NewObj = [PSCustomObject]@{
                FilePath = $FileInfo.FullName
                Version  = $FileInfo.VersionInfo.ProductVersion
            }
    ...
    if (($OneDriveVersions | Measure-Object).Count -gt 0) {
        $FindingDetails += "OneDrive Versions:`r`n" | Out-String
        foreach ($Item in $OneDriveVersions) {
            $FindingDetails += "Path:`t`t$($Item.FilePath)" | Out-String
            if ([Version]$Item.Version -gt [Version]"24.0") {
                $FindingDetails += "Version:`t$($Item.Version)" | Out-String
            }
            else {
                $Compliant = $false
                $FindingDetails += "Version:`t$($Item.Version) [finding]" | Out-String
            }
            $FindingDetails += "" | Out-String
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCJ2iSgCsawnM4B
# 34G6jZWaJGoW8DQP7EWOQfAoo/jE66CCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCA1hgSMrNm+iw/Qqpu9NVrOG450X7dSTi6tm0rHyyqMjzANBgkqhkiG9w0BAQEF
# AASCAQAHsni7S43yCrhnOnUYI7wkAAUu//fgNmqF/3pIe8d2ze9qniv02RC5glMO
# FGxAEIVFe0AOb2SZMsbJB6eHAt/juh8Ydl/foYca5Neb0I4E/UaQ36YWY0+y23Fn
# pnfqe5AoS+kFof4nXIW6mo651mn40hXtbxRZKrESX0jhR2aAJ9EByMfn+dpMKClv
# 6Xe+j6IpeF4YmYvCnyp115REn2Q/9mb8q8WATjz2ZQVZCNfHTgFy4Mzretfkzl3W
# 3iwFmjc+26jQSU0BhRFzN2uoah3ZD3W91a2HULbxtJCXZ0i1dxNujDP7AJtGlsdx
# Q30pk4TMHp43tuXiIJYUatlOHc5ToYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTE1MlowLwYJKoZIhvcNAQkEMSIEIHYnQn1EJnA0CM7maQmq+STcQKz/
# +673i0FA9Sk+8cD4MA0GCSqGSIb3DQEBAQUABIICAIBkqjKgtAP6+BK/NKcKtuRi
# UvCYqMrgMj+gGJZkYCVsY9lUbcJpQ65CiiEMNkeDj2isipd0xs3aJ8uUf2paMcyM
# LgibvaHh3IDYKgpHiQLwCiqYQN2g2MngXfBvHoarSyY5nLEumsD8PJZigPBphxCT
# Mziu/Alg9qo8tKOwOOLHhKsbWLrFFxJzYlgiE57cJZd9ye1AF8iOZIbGWxv4v+lA
# Yyjvd86rQgat9AkNFN/0yhefZk6DxsquNxSKQyOFcnFjscDzxTYsrXeAuLne6nSF
# Gzy4sILBP8Ouj3lDbaG6JhJef+gan46pzHIMU4aXFbufsjR9pg497tKE/mfwXY3k
# tvJtirGNqPls/4PFmOPD3NteL3A2uPh6HdsRKs3rE7sbt/Lm86IBvEZJCr77nGWL
# dsejtKTs/rThxLQFuTo1HYafaMD2YZ1bVMmWEUdPQBfikzEPNLxg2LYpdJaEmVWy
# nVx6QhUGbBqETcX8L1pVVUuOBWKxgmzumbMtI6PjNyvzrGMs/TOOgzgDqRV4kHa6
# qxaDRPVg6mAcTqmUONrkr4FU0+m/4Rbl7mo1YoJ2N6/h/767RC2TUxnlDHUn8Y6i
# qWSP8i5wF8WC5yXT+2YVqMpark+9j5bMB5NEq2njmJyK9M8NJ2xTTYY1WKp4mbXY
# x4M/lZpq9PKvBuhQeAmZ
