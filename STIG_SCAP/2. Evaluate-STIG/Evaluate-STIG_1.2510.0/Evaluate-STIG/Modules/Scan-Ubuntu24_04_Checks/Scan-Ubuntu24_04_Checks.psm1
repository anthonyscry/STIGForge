...
Function Get-V270650 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-270650r1134802_rule
        CCI ID     : CCI-002696
        Rule Name  : SRG-OS-000445-GPOS-00199
        Rule Title : Ubuntu 24.04 LTS must configure AIDE to perform file integrity checking on the file system.
        DiscussMD5 : D6179A650A723C87D9C34FF77244E790
        CheckMD5   : B2E7F5974727E01A136CA34B6C768CAA
...
Function Get-V270669 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 7364DB058EBB447961A608E7C1C88F82
...
Function Get-V270675 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-270675r1117265_rule
        CCI ID     : CCI-000213
...
Function Get-V270681 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 52A0FBCF0E4B6BE6205CA0DD0F3E0A87
    ...
    if (($better_finding_1 -match "^$($better_finding_1_path):auth.*,authpriv.*\s+/var/log/secure$") -or ($better_finding_2 -match "^$($better_finding_2_path):daemon.*\s+/var/log/messages$")) {
        $Status = "NotAFinding"
...
Function Get-V270714 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 178C558CD4D9B6C646CC32A3B2BCD188
        CheckMD5   : 0C1F4A68CD35F0CA78B69F0019477696
    ...
    #---=== Begin Custom Code ===---#
    $finding = $(grep -s nullok /etc/pam.d/common_password /etc/pam.d/common-auth)
...
Function Get-V270718 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : FF0AF2DCC3132AF9D9B5770E56FE88D2
        FixMD5     : 2D497B3A11FC91B5D90FC4BB85D29B25
    #>
...
Function Get-V270744 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-270744r1117272_rule
        CCI ID     : CCI-002450
...
Function Get-V270749 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-270749r1117267_rule
        CCI ID     : CCI-001090
...
Function Get-V270750 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-270750r1117267_rule
        CCI ID     : CCI-001090
        Rule Name  : SRG-OS-000138-GPOS-00069
...
Function Get-V270756 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 3319D28550DECD0F878CD8EB2C2596D7
        CheckMD5   : BBA92960CEA7A13EA9D2D630C7A88DCE
        FixMD5     : 2E930300BEA180E9D737974027AA57BC
    #>
...
Function Get-V270821 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 7160382F113FA445F6E77AF2D77F6583
...
Function Get-V270822 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 1236BD922AA09CD7F05D4C8BF38EF4D1
        CheckMD5   : 55197FB4FD1294DE042D87A0D3D30E8E
        FixMD5     : AB3E60A4812970110CC2582DBA096481
    #>
...
Function Get-V270823 {
    ...
    .DESCRIPTION
        ...
        DiscussMD5 : 1236BD922AA09CD7F05D4C8BF38EF4D1
        CheckMD5   : D1F81DDBEE2F2F0F159BDEE7416163D6
        FixMD5     : FDEE37C98C3F31D8CF50EDB5D38E64DE
    #>
...
Function Get-V270831 {
    ...
    .DESCRIPTION
        ...
        CheckMD5   : 9635A829B684A042147C71127A08B64F
        FixMD5     : EA42D75C3CF440B9EDAB4BD43C952423
    #>
...
Function Get-V278917 {
    ...
    #---=== Begin Custom Code ===---#
    $finding = $(grep -s -i DISTRIB_CODENAME /etc/lsb-release)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABC