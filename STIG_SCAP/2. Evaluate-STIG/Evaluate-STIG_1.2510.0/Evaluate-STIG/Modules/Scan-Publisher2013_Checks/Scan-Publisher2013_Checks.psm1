...
Function Get-V242799 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242799
        STIG ID    : DTOO104
        Rule ID    : SV-242799r961092_rule
        CCI ID     : CCI-001170
        ...
        CheckMD5   : 26F9DAA1927115937FEE01C4C1B89F45
        FixMD5     : 23BF3AAC7EC08DA73376E4E3A4016D3D
    #>
...
Function Get-V242800 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242800
        STIG ID    : DTOO111
        Rule ID    : SV-242800r960921_rule
        CCI ID     : CCI-001695
        ...
        CheckMD5   : B760A8B2457409F660C3E31C86872382
        FixMD5     : 51EC7889FBCCFE35E291F07098DDD458
    #>
...
Function Get-V242801 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242801
        STIG ID    : DTOO117
        Rule ID    : SV-242801r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        ...
        CheckMD5   : 054B94AC31AD5E07E64D946BBBE3A4DA
        FixMD5     : B2A7F1C059995F73F367F950E66FD197
    #>
...
Function Get-V242802 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242802
        STIG ID    : DTOO123
        Rule ID    : SV-242802r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        Rule Title : Navigation to URLs embedded in Office products must be blocked.
        DiscussMD5 : 15A059C11FCE317B8DD12BF6ACFF5061
        CheckMD5   : F502F55C9A632BCFF6B013B85A75F0C2
        FixMD5     : 0A2AA35EF79AFE8AF7730EFFD5DBE1C4
    #>
...
Function Get-V242803 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242803
        STIG ID    : DTOO124
        Rule ID    : SV-242803r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Scripted Window Security must be enforced.
        DiscussMD5 : AF7331982EDA6DD75AD391A9F8FCB25E
        CheckMD5   : AA24BFB9392B20BAC863521FA6B9BE67
        FixMD5     : 99811A67172A83F6A95A3C4148B61A1B
    #>
...
Function Get-V242804 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242804
        STIG ID    : DTOO126
        Rule ID    : SV-242804r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        Rule Title : Add-on Management functionality must be allowed.
        DiscussMD5 : F3B57D4C7A5FA60D66622E700722FF6C
        CheckMD5   : 5380FAAAA267A849662E2D0C39C64425
        FixMD5     : 489DF90B385A8ACFDA9944035326AC1A
    #>
...
Function Get-V242805 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242805
        STIG ID    : DTOO127
        Rule ID    : SV-242805r960954_rule
        CCI ID     : CCI-001749
        Rule Name  : SRG-APP-000131
        Rule Title : Add-ins to Office applications must be signed by a Trusted Publisher.
        DiscussMD5 : 1AFB295DD7496D749C34AE235FCD909D
        CheckMD5   : F2A6D5A78647DBDED5AEF3F365412E46
        FixMD5     : 1A90A3B49418057C16F12DE4C084296B
    #>
...
Function Get-V242806 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242806
        STIG ID    : DTOO129
        Rule ID    : SV-242806r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        ...
        CheckMD5   : 1DA8C12A6C7CCD4E2A0BD362A1874E0F
        FixMD5     : 693B835755C7110F9EC6EBE528CDB10B
    #>
...
Function Get-V242807 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242807
        STIG ID    : DTOO131
        Rule ID    : SV-242807r960954_rule
        CCI ID     : CCI-001749
        Rule Name  : SRG-APP-000131
        ...
        CheckMD5   : A12846D1813BBE04779BB25B03BEBBBC
        FixMD5     : BD02130C782125D5A2D0B87C087E3FAA
    #>
...
Function Get-V242808 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242808
        STIG ID    : DTOO132
        Rule ID    : SV-242808r961089_rule
        CCI ID     : CCI-001169
        ...
        CheckMD5   : E91F980180A00C67BD86EA9A2D430381
        FixMD5     : EEFD7B3F440BB66D069C569D1B4CCF45
    #>
...
Function Get-V242809 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242809
        STIG ID    : DTOO209
        Rule ID    : SV-242809r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
        Rule Title : Protection from zone elevation must be enforced.
        DiscussMD5 : EC61D2962043DE7A60FFD12586FDAE9B
        CheckMD5   : BE393FA0B76E517924C7AE55DEB7BD5B
        FixMD5     : 024E2C2A949DA516A63EAECC55D36DA1
    #>
...
Function Get-V242810 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242810
        STIG ID    : DTOO211
        Rule ID    : SV-242810r961779_rule
        CCI ID     : CCI-002460
        ...
        CheckMD5   : 2E167D5514B66DAF04BC4BE75CBF70CC
        FixMD5     : 9054956A016A09DFD9F6B3FBBACD0827
    #>
...
Function Get-V242811 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242811
        STIG ID    : DTOO304
        Rule ID    : SV-242811r960963_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Warning Bar settings for VBA macros must be configured.
        DiscussMD5 : B8207780D49B066EBB9F3E9084FC2A82
        CheckMD5   : B661C2996377F5E1599131D37B53B57D
        FixMD5     : A4C880046B128951E8A34F003FCC96A1
    #>
...
Function Get-V242812 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242812
        STIG ID    : DTOO322
        Rule ID    : SV-242812r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
        Rule Title : Fatally corrupt files must be blocked from opening.
        DiscussMD5 : CFDE0F69A91239942A7AAD93A308078B
        CheckMD5   : FACBBE86D59AD2DB6A1C0DFE30DBB910
        FixMD5     : 30B82988885784C5F8E224C416D9AB2A
    #>
...
Function Get-V242813 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242813
        STIG ID    : DTOO323
        Rule ID    : SV-242813r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
        Rule Title : The Publisher Automation Security Level must be configured for high security.
        DiscussMD5 : FC0D4A55317A2FA591CB62778FCEB42A
        CheckMD5   : 33D2D0616CA6205610EEFE6177BFE0AA
        FixMD5     : 6E8493E5FFB05DE695B563ED035E1450
    #>
...
Function Get-V265899 {
    <#
    .DESCRIPTION
        Vuln ID    : V-265899
        STIG ID    : DTOO999-Pub13
        Rule ID    : SV-265899r999901_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Microsoft Publisher running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : 47C76F78828DACA1308C9B34A28C76BB
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCa5wQLMR+vUfHM
# z8i9frje0HgYWzncWkYYbuDk8mBspaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCBt/RwdmTkUL+mAKxo+OYWlNNoVlg9OtBGuJrTrZT3A1zANBgkqhkiG9w0BAQEF
# AASCAQCpBuQSi2cpymnwUI43yk3cEdy4rs/tXgwNOpD3bnPO+RzTQfr1Ku91CMp+
# daq45DDhl4GbykBBJKpdzjkpbM2KFjgYiV3AVKc2IRXh5BaUY+maEpdXhM8DWZDO
# 2CW7bWmAhqTmIeyexfOYs3BjJpf/lIvr5ipcdTiHvMlizPtCWMIKmqeHTq6QXQZ3
# mOJC3U8OBdpewMsD3lM34qyBoY3d/nQ+Usqrf75M3sRBL3Zx0vPqKqGoPYWIDd/D
# mn2Xe7rPAj2qCQ0VCWbXlFbIML/zAk1om1oCefD1R3G7olM910QWnEMx4SEcpABj
# hWSzW0gtuQ7upbYfvxRFtjryPB96oYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTIwNFowLwYJKoZIhvcNAQkEMSIEILdUmQYmqFao2G/7aZRSDp5FyOKO
# 5KVVMxanB+zCwVb9MA0GCSqGSIb3DQEBAQUABIICAHRJazMT4gvJFaqu9HznIzfv
# GRu01d1Ued0MzelIhJTffm3+Fz+neG94D+VUG4y+JCNCPux/CpMSkpIugutfBpFj
# D3jVNRnUpB6+c6yrrPcoh0Sp9nPIUDRA9gEcl2DfldCd2xK75J9FaH30ni+281nx
# yUedSbCwzs3rPnu7aIHm3uqnOtIA04ujl11q8zzdBo9xMlOf5Mnig5LyhuaNFoYZ
# k94djBMRHE76DSfGrFut60zaVw3nGU3QQRUQbHigh8Cj9J4xfHuZBQrn3ZYgFC0l
# JBF5jkZ5zCb6vRX1q2oNFkdrQE2la9fxaBbQ1/CuwfRxWQ0trS20lJJKfx1GGAT2
# DTvsH4IX99dX+ORIfa+ZNqjcrFi8rBEz+XfuJb1gsqqpbf7ROwUaem4Y1g2YiKYq
# CQi5En79nE65PhWBaoWKTxmPsbArH7AT2twtE59RAf/LN62pkCOfpY6GrjGe+xIP
# 5y+YYZAnXz1UaFC8xtteakfDHTLw6Oh+oTdtp54d1xXt3tfcYFgwsdbFTJLEzbMd
# 8LbVvuppdaOZ123hxnrUrESriyN48IQKGRWmKW38YsQzmY62ejKc9S2Y8SyIUW7c
# KOaqKa680gW47XER73nCCb8goWdDpPRAdFBxIFvARN3t/yVc++BflyF0FsZ6uaoN
# 4DCnW8ekdLKafZLpNXvi
