...
Function Get-V254556 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254556r1117167_rule
        CCI ID     : CCI-000213
...
Function Get-V254557 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254557r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-CTR-000090
...
Function Get-V254558 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254558r1132413_rule
        CCI ID     : CCI-000213
        ...
        CheckMD5   : 11CEE0F58E81FB78756011AD164896F0
        FixMD5     : A08923C14BE24190FF0185F03E2764AE
    #>
...
Function Get-V254559 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254559r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-CTR-000095
...
Function Get-V254560 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254560r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-CTR-000095
...
Function Get-V254561 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254561r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-CTR-000095
...
Function Get-V254562 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254562r1117167_rule
        CCI ID     : CCI-000213
...
Function Get-V254564 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254564r1132414_rule
        CCI ID     : CCI-001499
        Rule Name  : SRG-APP-000133-CTR-000300
        Rule Title : Configuration and authentication files for Rancher RKE2 must be protected.
        DiscussMD5 : 0F4972395D477AC341DABCEAB6ADD884
        CheckMD5   : 94EB50750A347CF90DB2F59FC15DFFB0
        FixMD5     : 652FADDC34011413F888AB4D1EFFC5AA
    #>
...
Function Get-V254566 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254566r1132415_rule
        ...
        CheckMD5   : BC366F0152AA2CEA3C108D01C05DED62
        FixMD5     : 44FD481BEE680A048CE11ACD35A2C130
    #>
...
Function Get-V254570 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254570r1117173_rule
...
Function Get-V254571 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254571r1130613_rule
        ...
        CheckMD5   : EB300CD35ABF0685AE49901BF73DA751
        FixMD5     : 48E445880850EFE267CAD38C6B71A1B3
    #>
    ...
    If (Test-Path '/etc/rancher/rke2/rke2.yaml') {
        ...
        Else {
            if (Test-Path '/etc/rancher/rke2/rke2-pss-custom.yaml') {
                $finding = Get-Content /etc/rancher/rke2/rke2-pss-custom.yaml
                $FindingDetails += $(FormatFinding $finding) | Out-String
            ...
            Else {
                $FindingDetails += "system does not have a /etc/rancher/rke2/rke2-pss-custom.yaml"
            }
        }
    }
    Else {
...
Function Get-V254575 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-254575r1117151_rule
        CCI ID     : CCI-002605
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCW/FzN4w3KY7qO
# 8fG37NTw4H7XeKH8pkm2+i4X8qOrhaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# B