...
Function Get-V218738 {
    ...
    elseif ((Get-WindowsFeatureState | Where-Object Name -EQ "ADCS-Device-Enrollment").Enabled -eq $true) {
        $Status = "Not_Applicable"
        $FindingDetails += "This system is currently hosting Network Device Enrollment Services (NDES) so this requirement is NA."
    }
    else {
        $PSCommand = '
            If (-Not(Get-Module -Name WebAdministration)) {
...
Function Get-V218744 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-218744r1135545_rule
        CCI ID     : CCI-000381
        ...
        DiscussMD5 : 5D637778B495E6CEC82E8874DB6C6DA5
        CheckMD5   : 5C902A76BFF9D522402535693CF23EEC
...
Function Get-V218750 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-218750r1117171_rule
        CCI ID     : CCI-001082
...
Function Get-V218768 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-218768r1135547_rule
        CCI ID     : CCI-002476
        ...
        DiscussMD5 : AA592823A420B4EFBA410A5BC6A61880
        CheckMD5   : D4DA3891069F0EEABCAE1372AD4BBECE
...
Function Get-V278953 {
    <#
    .DESCRIPTION
        Vuln ID    : V-278953
        STIG ID    : IIST-SI-000270
        Rule ID    : SV-278953r1135550_rule
        CCI ID     : CCI-001312
        Rule Name  : SRG-APP-000266-WSR-000159
        ...
        CheckMD5   : 17F8EA6EC166A7A34F1848E9E3EF93B5
        FixMD5     : 48134D34BA4D2F52D626D880C1264B32
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCwoDqCfdfj3VhI
# hGktFzvV9iy3sN4AS/MP8QC9sFsYYKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCA7NETK7coD8AgUszq2CZLb06wokxPJ7J8WspJajocGezANBgkqhkiG9w0BAQEF
# AASCAQBg7J3IndgREp4cTjGCPLg0axY4VNx9clZyYCslLqHbxwoEHX+KzhYNSNvW
# lwincqh+fv6cEOAabwjOgCEObSLVVjcXt0YQPB9JD5xBFoMm4OjB3irRe99FSHAc
# V1ZhdMk6z0zB6bEHxsMqSL0+MbIYHDDiTj6Y+HgwADa/q9dKww/xsQQkHdNQW+No
# 7RMCFWcVC0+0bTJNHdq9zPJr6hmCJJKk/Ti+Hl6HX9yav5CtU9L3JPGzpGQ0ccRm
# bp4lp1FiXeyJtVJd1/6DF6MqzFfxyWdgpkGDm4pM3nRf+0RstPWUQHi60EXp5Bbz
# aLS5c+oHXIi/Kj2w2TFWZIiozEgKoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEzNVowLwYJKoZIhvcNAQkEMSIEIATvE+yGtkSNo331eIF5ry2IWbQa
# ffk93niJ++u+VZRcMA0GCSqGSIb3DQEBAQUABIICACQzKjy1SBAnU3Ijid2kynxE
# ADzX8K7jR8kd44lZHqM7Vlt4FE74cvIwy1kXTGYmUxXHTQW56J0UCokcwHa4NQgk
# cFGMkqG41okk0w3+0FAo0iZ19JUsbWxkaNBGROXWbA6Jj81X5OcBj7SARXXZX2t7
# X64isIP9wSnUa/rRGpLZalMFWLK+x0xpymNocssi10vrUa29lZ+ub16z0Nu7qfp7
# qA7COOMOtvKAa1oG4k8L+SLFHOPnFnNlLswvj5wcfxUaj+jayfs02nTS08BzDwvD
# 6xBFCc8PCj6ifOxqLG7tEVoPbpEza1GqwMs1XTYvWn+WBVUzbmaRQv8gA0wm1PNt
# U6+mOztwU+Ucz/v5U5I/jnr33obxo2wmD6t30GxewYeL+PS3OiUH9300rFclgNAe
# Qncnq4DnZCXoIyzG/K7255eQiajAmmZ0FihAyXU4m9bzJaS+aJXrPkO6dVU1jfTh
# 1+VLoVeFlvrb/GfOFDRIpag6KGwCTped/JpTiF02BX3B5Hw/n79tKvBwT5/WrO6b
# VO8yKWj8PGj1ZnAd8WZSO7iw/KfoDSXfYptcVfs1R4Ufy6p2Y8am/AcsHoZV4khl
# LdxeSEpF4tb68z++guDVGI+zXesel7sfseoQ1VecYaT2oTlMAt03muxwFqC7Q+OM
# 9g4OdZRS059TmeOHaeUh
