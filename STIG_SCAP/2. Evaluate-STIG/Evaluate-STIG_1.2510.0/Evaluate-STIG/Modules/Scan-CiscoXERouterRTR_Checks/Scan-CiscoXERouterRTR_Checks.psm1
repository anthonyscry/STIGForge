...
Function Get-V216641 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216641r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216646 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216646r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216661 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216661r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216662 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216662r1117241_rule
        CCI ID     : CCI-001109
...
Function Get-V216663 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216663r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216666 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216666r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216667 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216667r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216668 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216668r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216680 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216680r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216681 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216681r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216687 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216687r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216688 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216688r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216689 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216689r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216690 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216690r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216692 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216692r1117236_rule
        CCI ID     : CCI-000032
...
Function Get-V216693 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216693r1117236_rule
        CCI ID     : CCI-000032
...
Function Get-V216717 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216717r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216718 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216718r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216719 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216719r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216721 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216721r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216722 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216722r1117237_rule
        CCI ID     : CCI-001414
...
Function Get-V216730 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216730r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216731 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216731r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V216732 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-216732r1117236_rule
        CCI ID     : CCI-001368
...
Function Get-V230146 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-230146r1132551_rule
        CCI ID     : CCI-002403
        ...
        DiscussMD5 : D5AEB86C8C037E454BAC539F6E003704
        CheckMD5   : 59EFC7AF5C83E2173B878C6C9637F924
        FixMD5     : 7BCF299C0FDE1D12BDCC57FA5D94A607
    #>
    ...
    ForEach ($AccessList in $AccessLists) {
        ...
        IF ($AccessListConfig -notcontains "deny hbh any any dest-option log") {
            $aclCompliant = $False
        }
        IF ($aclCompliant) {
            $AccessListName = ($AccessList -split " ")[2]
    ...
    ELSEIF (!$CompliantAcls.count -gt 0){
        $Status = "Not_Reviewed"
        $FindingDetails += "There are IPv6 interfaces but no ACLs found on the device that drop IPv6 packets containing a Hop-by-Hop header with destination option properly configured." | Out-String
    ...
    ELSE {
        ...
        IF ($UnCompliantInterfaces.count -gt 0) {
            $Status = "Not_Reviewed"
            $FindingDetails += "The following IPv6 interfaces are not configured with a compliant ACL for this requirement. Verify that an inbound IPv6 ACL that drops IPv6 packets containing a Hop-by-Hop header with destination option has been configured for all external IPv6 interfaces." | Out-String
            $FindingDetails += "---------------  Compliant ACLs ---------------" | Out-String
            ForEach ($acl in $CompliantAcls) {
                $FindingDetails += $acl.ToString() | Out-String
            }
...
Function Get-V230150 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-230150r1132503_rule
        CCI ID     : CCI-002403
        ...
        DiscussMD5 : 18FA342C157A6F88D0745F8DA575CFF7
        CheckMD5   : 5203526873544A8EC080E80983F8CE81
        FixMD5     : 3409BC85122B949B9723A8047CD3B4E4
    #>
    ...
    ForEach ($AccessList in $AccessLists) {
        ...
        IF ($AccessListConfig -notcontains "deny 60 any any dest-option log") {
            $aclCompliant = $False
        }
        IF ($aclCompliant) {
            $AccessListName = ($AccessList -split " ")[2]
    ...
    ELSEIF (!$CompliantAcls.count -gt 0){
        $Status = "Not_Reviewed"
        $FindingDetails += "There are IPv6 interfaces but no ACLs found on the device that drop IPv6 packets containing a Destination Option header properly configured." | Out-String
        $FindingDetails += "Review the router interface and ACL configurations to determine if it is compliant with this requirement." | Out-String
        $FindingDetails += "" | Out-String
    }
    ELSE {
        ...
        IF ($UnCompliantInterfaces.count -gt 0) {
            $Status = "Not_Reviewed"
            $FindingDetails += "The following IPv6 interfaces are not configured with a compliant ACL for this requirement. Verify that an inbound IPv6 ACL that drops IPv6 packets containing a Destination Option header has been configured for all external IPv6 interfaces." | Out-String
            $FindingDetails += "---------------  Compliant ACLs ---------------" | Out-String
            ForEach ($acl in $CompliantAcls) {
                $FindingDetails += $acl.ToString() | Out-String
            }
...
Function Get-V230153 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-230153r1132506_rule
        CCI ID     : CCI-002403
        ...
        DiscussMD5 : 01926DB5080BD82509162FACAFE6688B
        CheckMD5   : 5BB1C80BF8E63EFA005F2DB0621FBB12
        FixMD5     : 4574F304E2E3A6FD9BFA9F292A8185D3
    #>
    ...
    ForEach ($AccessList in $AccessLists) {
        ...
        IF (($AccessListConfig -notcontains "deny 60 any any dest-option log") -OR ($AccessListConfig -notcontains "deny hbh any any dest-option log")) {
            $aclCompliant = $False
        }
        IF ($aclCompliant) {
            $AccessListName = ($AccessList -split " ")[2]
...
Function Get-V230156 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-230156r1132509_rule
        CCI ID     : CCI-002403
        ...
        DiscussMD5 : 13AFDC9E76D76A4A49DCD9400A5702A5
        CheckMD5   : 5BB1C80BF8E63EFA005F2DB0621FBB12
        FixMD5     : 3409BC85122B949B9723A8047CD3B4E4
    #>
...
Function Get-V230159 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-230159r1132512_rule
        CCI ID     : CCI-002403
        ...
        DiscussMD5 : 99ACC61E7D072804AED356A3216E15CC
        CheckMD5   : F8559174059B664048F58B8E873E5DB4
        FixMD5     : 5E278C6D850EC15D8E93ECAC92FB4E30
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA21Rlpq6hGaCKx
# DmxVNWCOsC8zTzCMiW8PKiKGJKrMXKCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCAwl0oztC0ZS/YNPCpLRVfFeorolUNJQdqeNF5zGnMogTANBgkqhkiG9w0BAQEF
# AASCAQAuUs3iEYnFJMFsWjSi4738ztrUhcn7aurO565V+XMpbOqk5c8OTnZh9qjd
# 6rkEQF8ISdaF4WQcdNigeYSV+Iabl8IxbfbXpDMqJ9vW2D/Yptp84gauxLbhPwQe
# nr4j3NnoY0gLbzrDqp+QkhB/3ncfoKzQZNDZ6y/82cKVISjJuBSTIZ/XmJCl2AD2
# s1zHxFigdlJyqwuVa/p7LUBjSa+gaIzyjvAHAiF+XmHzjU4Zr555g9cYzLWespt8
# 5YScjHsA+Z9IlPJBv+QxoFFNU85UKVbugRlwWzPadyNyj8b9AsLns4vtzyW+StQ6
# BvPR61AWzMZa0xq4WwxCvBxG4crZoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEyN1owLwYJKoZIhvcNAQkEMSIEIBgRVoiiKYy4iMYWMsunPLuvJct6
# uu3M7DQKZ9mq3AuGMA0GCSqGSIb3DQEBAQUABIICAL19Y4xMcx+NqIAFWK7OmC9a
# CH1QtkwrdIQvBHAVd7VZmLwJTljtHjAxhVw+krkIoLrl9ITct+5NSZe7xPndMl8F
# gFFMSRS840zUb2pW+7V/gw5GpQgVGZCASpwDpuUvM8rqIHZJznWYDur6faYOvcGF
# F7J4nIfn0dnanIc81pKe+qEtDX/QUIqvTVaH0U5aq3x6L/4mzKlX9dYTj8AnwPx4
# enBkxXyoyIo3CjA6Hy/xNicS2XrQBj1f5AHpqwKkB7wRerD1N7Bx1buezrtOF0+z
# nTjzN25HZRCQ+5T6+whazdjrsS3Zc62Aodu4wkRHB8ZJm4W4CCtMO0R1lOtLJX4x
# U41xeMnid/eJn2YZDu+YjzQZC/8STAPeFfzbd5zUECoxl9DJa243VMZ+f6SbZ9MU
# 2/9qFGNu0PWNO2jUqsDM/G6QIBckelSwq4NA91R6zXxy7bm0T2dH15tNWLaYsWXp
# QY+Qa8cKbSOndenXWU2A4dJrLwYVr/CRZWVfd//r5EzklwOWGg1tsv6evZCeGWIm
# O4wFC2fILzDEg2gSuCGz4DDo4a2tumZc952GE5XdOTToh7fQKQiLjimyHjJgNYZP
# RQxV0eS1SVNz0OSF08MTTvL4aCTlMhsTeG2VrCrEXhkZmWDhgEXRYoOFCBa3wjZc
# SC5O18XNA4XW4PG+50Rg
