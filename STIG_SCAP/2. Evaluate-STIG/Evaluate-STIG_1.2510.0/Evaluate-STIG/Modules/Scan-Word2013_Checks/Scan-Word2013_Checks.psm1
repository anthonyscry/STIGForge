...
Function Get-V242827 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242827
        STIG ID    : DTOO104
        Rule ID    : SV-242827r961092_rule
        CCI ID     : CCI-001170
...
Function Get-V242828 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242828
        STIG ID    : DTOO110
        Rule ID    : SV-242828r961086_rule
        CCI ID     : CCI-001662
...
Function Get-V242829 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242829
        STIG ID    : DTOO111
        Rule ID    : SV-242829r961086_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000207
...
Function Get-V242830 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242830
        STIG ID    : DTOO117
        Rule ID    : SV-242830r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242831 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242831
        STIG ID    : DTOO119
        Rule ID    : SV-242831r960921_rule
        CCI ID     : CCI-001695
...
Function Get-V242832 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242832
        STIG ID    : DTOO121
        Rule ID    : SV-242832r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242833 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242833
        STIG ID    : DTOO123
        Rule ID    : SV-242833r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242834 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242834
        STIG ID    : DTOO124
        Rule ID    : SV-242834r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
...
Function Get-V242835 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242835
        STIG ID    : DTOO126
        Rule ID    : SV-242835r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242836 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242836
        STIG ID    : DTOO127
        Rule ID    : SV-242836r960954_rule
        CCI ID     : CCI-001749
...
Function Get-V242837 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242837
        STIG ID    : DTOO129
        Rule ID    : SV-242837r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242838 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242838
        STIG ID    : DTOO131
        Rule ID    : SV-242838r960954_rule
        CCI ID     : CCI-001749
        Rule Name  : SRG-APP-000131
...
Function Get-V242839 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242839
        STIG ID    : DTOO132
        Rule ID    : SV-242839r961089_rule
        CCI ID     : CCI-001169
...
Function Get-V242840 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242840
        STIG ID    : DTOO133
        Rule ID    : SV-242840r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242841 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242841
        STIG ID    : DTOO134
        Rule ID    : SV-242841r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242842 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242842
        STIG ID    : DTOO139
        Rule ID    : SV-242842r960963_rule
        CCI ID     : CCI-000381
...
Function Get-V242843 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242843
        STIG ID    : DTOO142
        Rule ID    : SV-242843r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242844 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242844
        STIG ID    : DTOO146
        Rule ID    : SV-242844r960963_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
...
Function Get-V242845 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242845
        STIG ID    : DTOO209
        Rule ID    : SV-242845r960921_rule
        CCI ID     : CCI-001695
        Rule Name  : SRG-APP-000112
...
Function Get-V242846 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242846
        STIG ID    : DTOO211
        Rule ID    : SV-242846r961779_rule
        CCI ID     : CCI-002460
...
Function Get-V242847 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242847
        STIG ID    : DTOO288
        Rule ID    : SV-242847r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242848 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242848
        STIG ID    : DTOO292
        Rule ID    : SV-242848r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242849 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242849
        STIG ID    : DTOO293
        Rule ID    : SV-242849r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242850 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242850
        STIG ID    : DTOO302
        Rule ID    : SV-242850r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242851 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242851
        STIG ID    : DTOO303
        Rule ID    : SV-242851r961863_rule
        CCI ID     : CCI-000366
...
Function Get-V242852 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242852
        STIG ID    : DTOO304
        Rule ID    : SV-242852r960963_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
...
Function Get-V242853 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242853
        STIG ID    : DTOO328
        Rule ID    : SV-242853r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V242854 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242854
        STIG ID    : DTOO333
        Rule ID    : SV-242854r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242855 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242855
        STIG ID    : DTOO334
        Rule ID    : SV-242855r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242856 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242856
        STIG ID    : DTOO336
        Rule ID    : SV-242856r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242857 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242857
        STIG ID    : DTOO337
        Rule ID    : SV-242857r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242858 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242858
        STIG ID    : DTOO338
        Rule ID    : SV-242858r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242859 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242859
        STIG ID    : DTOO339
        Rule ID    : SV-242859r961086_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V242860 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242860
        STIG ID    : DTOO426
        Rule ID    : SV-242860r961863_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
...
Function Get-V242861 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242861
        STIG ID    : DTOO600
        Rule ID    : SV-242861r961092_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V265902 {
    <#
    .DESCRIPTION
        Vuln ID    : V-265902
        STIG ID    : DTOO999-Word13
        Rule ID    : SV-265902r999910_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Microsoft Word running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : D9D07C6D563D48CF343AB55A47318CE3
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDP4jiSZ0yax6cI
# V/5VonOcrv56AV2Qk4bhRgmby5WeR6CCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCBbiTL5eRaQTWcUsE2+Q8h7I/oi2pUPt9PP+4Q5pfaAVzANBgkqhkiG9w0BAQEF
# AASCAQBO5fz0cLYnShin/eLauKj1eZ9zbylWjtc9duzScc3YC+zoI0fSthQtOCxu
# WhsG6uRAPIkbvWRY4/QPDVPLhkc0YNyL7La/p0VkYX1GH/lFVz6HyAV4ArMWIpyr
# 4lvSwBfmrJRkcIn2FRFxwb8u/mJObWGHFqbjnvB429SH9q/PdtukOg+LOVb0d2qN
# TmnMwVrya2wTybs1QLPza2K2UeG8ZnvGwc64FwDJQOfRU9Yd2sja8dkcjD3cwewg
# 6wezn/2KbBQauKQveKJIJ0DqjAKmkDuiU2ynmksIcfQUiXncx3su+NIJwCFYUm/N
# L9Wo1h2e5bsxCyKv8viASPVITRq3oYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTI0NlowLwYJKoZIhvcNAQkEMSIEICfxLz7m3DmTHIoCXVid7T0MqbI5
# 1Ju7C2IAyfrGgv7rMA0GCSqGSIb3DQEBAQUABIICABK8vaGykS4y4EQq7gWguQun
# Y5yIktX1zOASFoB9a8/rCObhzz5tNiYKNdzq7UqH+6No9fyXORrp7rPK+iklSBui
# rCAsVVGo/m9DA1/CxbrbxlVWPtPIEQU3fnorERsqti0aqJgm0Xq4qPd/BO/S55tS
# Fefbb4hvJ4VXMD737hEQlj3j+h2ktVu9GqeE/6d5tjEiFFy7m71Y84vLRihtEPFa
# Y85USkLJEeAMwvW3/o6W/iKfcumKkI7fzrh4utpK/MU8VQqIV4E28oOILmW9lxNh
# hy7NM/f1J/HndTCArtk7u8N8WpeGYKR0xjR10YnCGfdpcaoq1gZ0cUa6Ha6A2WE0
# GZ+jvpgW3F97Y34P6LcIBwqxQBu81SPEERvfmzhwoy6xO7BMfvoP5uR24wZim3eW
# zqXWgdRELJl7qPjzVXd2LcZYD/pNkGk/R8hdIfxC0UCqZ/5CsIR+NE5fmAZ7nZub
# fucyLfwwpPOlj7G30lp2vx0SW3E5hOrgfBSVgIjoQrR+MKNYErT72lFtiYIupc/J
# lqXGwGiPvDWtD15VH3WUF42/67oTFrL5AcrVWaalJKzgfdT4RgB0bkJiXQ9L8uga
# c3feBHiB8YB/noJlxBDeSXJkTPkjXt3Lf1ZPBUDS7Y0qaKRONTgvaP7NHwrvY6sZ
# sAS7TRhCyeWXPfYaE9pk
