...
Function Import-Asset {
    ...
    Foreach ($Scan_Object in ($Scan_Objects | Where-Object {$null -ne $_.STIGInfo})) {
        ...
        Try {
            $ImportRules = Invoke-RestMethod -Uri "$SMImport_API_BASE/collections/$SMImport_COLLECTION_ID" -Headers $authHeader -Method GET
        }
        Catch {
            Write-Log -Path $LogPath -Message "ERROR: Unable to obtain collection info, aborting..." -WriteOutToStream -Component $LogComponent -Type "Error" -OSPlatform $OSPlatform
            Return
        }
        ...
        If (-Not($assetid)) {
            ...
            if ([bool]::Parse($Scan_Object.TargetData.WebOrDatabase)) {
                $body.metadata += @{
                    cklWebOrDatabase = $Scan_Object.TargetData.WebOrDatabase
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZgRgsGSjK4tMH
# QhLPGxNjAQSCVQB5p0FVSnEbU7CZ/aCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCAXgVbu3w7LH7IDDB6DWCQhk8lcpVAGjXRqKZ7v5zBsnzANBgkqhkiG9w0BAQEF
# AASCAQBak/B8dl3auTvtiw9eHUzNS1zNWHJrOiZB6nA19q+SSW5lNEEdvdNIoAqv
# tePrUlfLi9VS0ws2Q6/2zTfjASzPKXoMY7T94kAQEeIbqlZOMOxbcLlMCSlmK3Ll
# ZOBIRRfx8vaX/u2axdwu0TB2DMkFAr0e577FEXPfIDy7rtoX2CFbs0Ew2eXaW9DG
# LlI/j4d7KjBghkAtyx4Jrc5HSl1a48X4eHotwRytQiKR76eYGtbMaa8fS8OhGZFH
# 3E7FTIQGaCHHhPMf/3+KmTBdnCyV63p0rJ5R03zbM9anF9FHeIlUMWpxUHfrPEbO
# xdF+raOJBQLfYaWzTsgMA1ZHRLYooYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEwOVowLwYJKoZIhvcNAQkEMSIEIM70MU2U0VD58dgzCZ3YWr5w4Xqt
# huez/x+k5BjMShEIMA0GCSqGSIb3DQEBAQUABIICAMfeIo6PZzy7VxJwjlDbQ5sq
# 4071vWRDpWdyf9bb36LZX2mPt7n7vQF5JSkcBXF0x4Co5p20toyES4JmgQNC6Dvw
# 8J0bnQz8QGHynVJyi5hEw8oU3kxCxcZcqn6LhXTjnMMN9Cg2AeWZWO4MvfNwQGt1
# 8grGXL/iuZZ9V3JOjBvaw92lLEh6PFmK5PPfaT2zr2R42Bhtt/yUPi+nU+g/mP+L
# O+qe3HCVpvDsSx2Qp3TbKxGWDQgmnk5cpQkw/YNdzIKXuXSstb+96FO5+GUkzUeL
# P3pN/kWcwf1DcaFjSsTQc0H2H07NV6JPoXxBsP4CM4kiJd6YYS5WeHISyAO42nzD
# IkxZb6VcjfN00Hsgd4nxVfOqKbQ7Ns3M+RhxR+xiLGOK55cGT+kyIAIJw2zCkkeB
# Brj3YjtXh3M0RzdNi2Aw72AkHGq20aFEg2+xhHUCJ1WMDfTUyrdyRys3lLCRxtR2
# RpR1inmxQyzUPOSkwJuwwARZcChRz4NrBhzPVKT5TvjtsLEQOcuENev0ZtbMEy84
# C2JlaewSxvHe50gt4+Y9O31ZL52UzGRHaW6tV3OHBgvt5oUL8jCY8MwgI7Moxk3Y
# THwwW8bUFjkusNx+Lr3Q5YWMoSZesZVJfJQ1KucGxi6dBIEgXu2d+5jo+Ue/9nlL
# G19wAfJDjAS4tAY3w8GA
