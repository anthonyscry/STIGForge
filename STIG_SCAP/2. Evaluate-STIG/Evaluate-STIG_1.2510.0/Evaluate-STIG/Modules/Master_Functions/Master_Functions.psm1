...
Function Remove-TrailingSpaces {
    param (
        [Parameter(Mandatory, ValueFromPipeline)] [String]$input
    )
    $($input -split "`n" | ForEach-Object { $_.TrimEnd() }) -join "`n"
}
    ...
    Switch ($OSPlatform) {
        ...
        "Linux" {
            ...
            $ScanObjects | ForEach-Object {
                ...
                "  CATII_OpenNRTotal: $($_.STIGInfo.CATII_OpenNRTotal)" | Out-File /etc/Evaluate-STIG -Append
                "  CATIII_OpenNRTotal: $($_.STIGInfo.CATIII_OpenNRTotal)" | Out-File /etc/Evaluate-STIG -Append
            }
        }
    }
}
    ...
    If ($BoundParameters) {
        ForEach ($Item in $BoundParameters.Keys) {
            If ($Item -notin $IgnoreParams) {
                ...
                # Recreate the command line from BoundParameters and enlose any with white space into quotes
                Switch ($BoundParameters.$Item.GetType().Name) {
                    "SwitchParameter" {
                        $CommandLine += " -$($Item)"
                    }
                    DEFAULT {
                        $CommandLine += " -$($Item) $((Receive-NormalizedArray -Array @($BoundParameters[$Item]) -Action Quoted) -join ',')"
                    }
                }
            }
        }
                    ...
                    if ($UseSubProc) {
                        $PSCommand = '
                            Try {
                                ...
                                Set-Variable ResultData -Value  "' + @($ResultData -replace '"',"'" -split "`r?`n") + '"
                                ...
                                Set-Variable ShowRun -Value "' + @($ShowRun -split "`r?`n") + '"
...
Function Get-ProcessString {
    ...
    if ($IsLinux) {
        ...
        if (($PsVersionTable.PSVersion).ToString() -match "5.*") {
            $processString = (Get-CimInstance Win32_Process -Filter "ProcessId = '$($ProcessId)'").CommandLine
        }
        else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSsLVZqN2OF7XE
# lJxopYrl4zJZLWPzKRjG6gfDII+O5KCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCBnO/SD3toHkFoJHvEC4bnJXJpLHn2vfBL80azgtO1GhDANBgkqhkiG9w0BAQEF
# AASCAQASXUurcPOLianYB51Ex1Bl70aK2o/H6f27VvtKuD6P0Ddg9+lycbB5JM/r
# QoX5ZpFLTF+A2Wkv/r5AXZI8Ikrj6R8T1sBYQYJWXfN2Fe+vRHt54RzwTW7/Xy2Z
# 6N6CfthW4nu37eP7ZPMQVd/STTpeC5rIepT2ool56OvEE4CDLPjHWkZjoaunvHMN
# WEvMCo6JJBeDuERZcSbxUwV0S1jc8SRUuGEpFTESXFy2i7O0F8qxroyh3mGbLvND
# nEH2rEKEB3x5MdTS0UihK1pttCMOsmjQmRp4DJHyMIW1L7azglx1GazFZ27cuV6H
# shegzJItNuvFgI92b8uicWwfKRmUoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTExMFowLwYJKoZIhvcNAQkEMSIEIHRLQ5zUjh5jTjwURrvZKw9JwRvt
# PkKgcup0hQSaLQkMMA0GCSqGSIb3DQEBAQUABIICAKklHuYEuwDq2eTGIHbfELCx
# vknLkIM6IiXYlMETvk1zXh/9ExFVs02E3ayr1R/yQSrbVBBq5fFHRX90AI96olDt
# 5pZRJ5ZJ6u1nfvDfMhSD0cC9Ruc4WYSgfoEivdANnATGJXtPaKL/eCogq1SSPCCs
# 9kuXMHVcWd2rfaO8oFicki6NKOhND9VjTwwlmyXxYf+yyxZBEcOl1nCFx6OVBcNX
# EQyh4AbwaR60ZCNcWSOZHaCvfb1zszJq93av9KR2Eaewul8mYEoTc/4Vk90giQFZ
# WQufGG/NvJ/CAUEgxf+ATZHR+tdNTM6SGN+Br+t6vACUkzqdUBhBhu3XYSz+DPNV
# 20AiMVmnEov851E/dRP1+PVWe53X8UCK1InAd+cSmdpnceGQ5yhi1VKsDc2eKFnc
# 0VZ6Qm79Pu6diCCGup+oVV/ZXddWWB38dlxpMB4AGuvSS1xtbTtJN3L1+wJBIwz6
# XgV6rkealLwxhUCbTIiVMRslc4uEPDCzaoxEJcjGk363ixpc2lZP2cPK2xsJOXY0
# YsFrDYBojVwyUpIGV4i1KutVnCQ//FQtzjCl4n6nLi+4FfqyM51CuUfOjh7ETLPS
# zy5S5WfO53nL0y19xB6hqGQsvMTgi32KLzXTR4NvAWwb+R427uYbOOjEST8gu7OT
# ol0nQ9lmrPdhAvI3S6A2
