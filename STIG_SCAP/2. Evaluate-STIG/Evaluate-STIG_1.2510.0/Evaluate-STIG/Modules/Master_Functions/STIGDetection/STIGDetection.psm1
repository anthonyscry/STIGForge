...
Function Test-IsArcGISInstalled {
    ...
    Try {
        If (($PsVersionTable.PSVersion).ToString() -match "5.*") {
            $IsArcGISInstalled = (Get-CimInstance Win32_Process -Filter "Name= 'ArcGISServer.exe'" | ForEach-Object {Write-Output "$($_.Name)"})
        }
        Else {
...
Function Test-IsJBossInstalled {
    ...
    Try {
        ...
        Else {
            If (($PsVersionTable.PSVersion).ToString() -match "5.*") {
                $IsJBossInstalled = (Get-CimInstance Win32_Process -Filter "Name= 'java.exe'" -ErrorAction SilentlyContinue | ForEach-Object {
            ...
            If ($IsLinux) {
                ...
                Switch ($Version) {
                    ...
                    "RHEL8" {
                        ...
                        ElseIf ($OSRelease -like '*NAME="Rocky Linux*' -and $OSRelease -like '*VERSION_ID="8.*') {
                            $STIGRequired = $true
                        }
                    }
                    "RHEL9" {
                        ...
                        ElseIf ($OSRelease -like '*NAME="Rocky Linux*' -and $OSRelease -like '*VERSION_ID="9.*') {
                            $STIGRequired = $true
                        }
                    }
                    "Ubuntu16" {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAvgf/qW7BdMKOs
# FX4gNZLrWbeybAluqJLDtOKbE2Q2FaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCDl80xPjILddtvWFOdIsLhT4ORPI6axQ0LIhtjiL8Y2pTANBgkqhkiG9w0BAQEF
# AASCAQBufvcC28dsFyNN68HAT8C7YS5XELmuweXM7RScvCuHo2um54rl7Moot8Gb
# 5AIgSKXJoJ10hNYtv8EirTPtr13g+NJn6ThFE1OAo4Mw4wqOkzbHmRHyA0L+Xng+
# g6ysDFVX1QUZXc85oDSFeQTN0MjUJTUkmn023fIOYNtSZxuJMy23JNhRV/HQqLVs
# /9R4JzUWWqSyjhNEd/c0a7KFm2/LqSzUSPd/xt0ffLUHlCb2E8RwvfO9Os2vVzpX
# QHlhHghFdeC0X+O9v8A3nPuPIlNmjKXWwuAmJ3rai76ywRX1jnPk33ggNIH3NSAK
# pkpfGG9uBQZcHp4/KiIcuOoXBrA7oYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEwOFowLwYJKoZIhvcNAQkEMSIEIHt8DETSeAMPhNn1nqusitJxqmjB
# jL/49zpvNwaCL3LnMA0GCSqGSIb3DQEBAQUABIICALnr2lC4D1fx5potFbNdfspk
# zDXU1f2Tsgxfodn0LpTpi1IX4pWjdjLLlPKEBJiIDFs3BAhqsbz/XUds+QsP2Nxl
# gQTYNecxKktHJzhXrkcxpmRley5sacRec1Dv+coQzY564K9HjQpVHcCPkR47dy75
# I2x2NVIljQ8q8axFwFMCxP+W9VjrpVE6u/xOBPdmaYdzO4kC+AKzpjljrousnR9E
# 6jo9frA5JNPiBwhOw0J4sRDFwuuYLMo8QHXOjGQO08JGETNBpYKEzPHSwyTbisaW
# /xDm8bg79npL/uTSQdUbzty4+lOUOokSnMpNMj5vQExqC3Z5D9B6HlGn0se3D79r
# 3IcUQxPJ8xRET2FoPp4T6oIy8cA6hWajxSgW29NxvJfa39Kg/AJXnTlgFPh4Jxub
# lpSKohxnroExgDEETknFlIWs2OONxHy4fe2F1vyvNsPwQi1h1i7QYSiEDpcCeH7k
# 7Evfn5R0VOaioA1tVO6L6/gwwDyzWf/A+Fs74o/G4qEWJ3tEIyO0aL6VAD9M1wdN
# qzAyvpHxXPCSrLyRh+k4q79TfNTJw3d911m1cqQi/mcZHyOV0QLKM5HyemrPJXvo
# V8L+uFJ8voluf/WscC0DyHoozqzp5lt6Zm9WAdqYCTz9M/IgEpKDfrXZ99PQIQ1O
# NVpmLFsb0E0LA9DEuV9h
