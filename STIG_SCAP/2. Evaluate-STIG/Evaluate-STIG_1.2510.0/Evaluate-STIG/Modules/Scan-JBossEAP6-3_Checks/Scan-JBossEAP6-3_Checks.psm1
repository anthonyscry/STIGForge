    ...
    if ($IsLinux) {
        $ProcessStrings = ps -ef | grep jboss.home.dir | grep -v grep
            ...
            if (($PsVersionTable.PSVersion).ToString() -match "5.*") {
                $ProcessStrings = Get-CimInstance Win32_Process -Filter "Name= 'java.exe'" -ErrorAction SilentlyContinue | ForEach-Object { if ($_.CommandLine | Select-String -Pattern "jboss.home.dir") {Write-Output "$($_.ProcessId) $($_.CommandLine)}" }}
            }
            else{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAUATilbUcciTl1
# ZO0IgdFR0hCn9QYgU2/x5UNFr5pXBaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCDZ4Bxf2J/2dF7j/mioxASxZZsHUKOMqMZK+vM9XQMGmzANBgkqhkiG9w0BAQEF
# AASCAQANCbnKGf3tmepL7EyxMY2VtOBx47EyqMM33/mpVlBo5M8KQe5kxN/LlKuR
# mXmJCwwOZMlTgXzuOZyie4YWtU5dBskcBSqwujxp2WLz53CYvLdD/GCtQeMuK9Jh
# QudELQ5sXmEsRK3lBox6Os3glcusCz0+VcPKyxI99ghHLc6qE4JhVvveUxHi3IVU
# xWE+OjQ7wG+HYGRLQQ/OonKyoApLGFfThFOXYAEN3DtldQGTennCXDlDxAbcq4w0
# CdO79H3EY88JchZGs8TAIllv4bPsY8d1LnFTnf1FWHWBnJ2k7TJUN7aIfDhB7/yu
# P4QC1kY71oCbakg8+jjYvk/ufcc9oYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEzOVowLwYJKoZIhvcNAQkEMSIEIJOJsGI/o9HmxgzCRzNICanFa1E0
# nj/3KlK8GWIYsARfMA0GCSqGSIb3DQEBAQUABIICAD38izZB1Y45fy/m6F0NuJjy
# 3vDJEcefhnoX3ZEhwJ6ZUUush7icc4Ho+HRY2JS+b1nfocN18wbgbzLnBCY9kk/r
# 9RFvTHN3yQukDRS0bODe0X9LsYMhtrfsUMuAyMj2kkAfIJ93kaNQGnpp96fJt21Q
# pkf0vLMhQLIiIWmhinlkG8wUVaA7XqKdR7zvMhPY/5bWnhobGqnabZKpu/JL2tmR
# CyF1KD2AXOr8BgPr6Vto1bXcqRQUfnUsnRFBoWJqRhQWVrUpHSVqcXjA/Bpa9xZP
# J7J7SQ4XrPv4/XbtW9GM/hO8/vqxXFKfqiWkg6iBi5fXs9UCD9Z1ysWJW3Ei1cda
# tHNjzNSwzwKJ/zMmceds0GRbh8f+N1AU3/rV4pIN/UJEEXz4iozN+awkvsgDyI10
# FgKJRXCABAUqixBFy6b4i6gCpfEX0f1SUoct0Dftc0HYtDbozrvM18SrQ+YIXjJb
# ZumJSiHFrn+iYZTciDNqdTYocbOJu4UwJTm297kvwjYWbKkEO6QZs54byQ6kP6nq
# s2e57WtxUY61XSCKRUHo5ME9ehU5byIvkQ/Vj6ovFTXj9q85WLwstO2xXXZu4hDB
# U9j9krMKrzbTH2xUmHK04pW/B3WUSwY8y5s3qOkf+BGGIskVmcATw1LrvlHmTveG
# F4JaWXkzOXZxM5ZmxU0u
