...
# --------------------
# STIG:     Citrix Virtual Apps and Desktop 7.x Workspace App
# Version:  V1R3
# Class:    UNCLASSIFIED
# Updated:  12/11/2025
...
Function Get-V234262 {
    <#
    .DESCRIPTION
        Vuln ID    : V-234262
        STIG ID    : CVAD-WS-000855
        Rule ID    : SV-234262r961494_rule
        CCI ID     : CCI-001953, CCI-001954
        Rule Name  : SRG-APP-000391
        Rule Title : Citrix Workspace must accept Personal Identity Verification (PIV) credentials.
        DiscussMD5 : 099A4342A28C50B5619B10DA9E5489AD
        CheckMD5   : CC3C4F29017BAC48DD7DF2E991D6C008
        FixMD5     : 3A6A988B18D6680985CED243DB6992A8
    #>
    ...
    $RegistryPath = "HKLM:\SOFTWARE\Policies\Citrix\ICA Client\Engine\Lockdown Profiles\All Regions\Lockdown\Virtual Channels\Smartcard"  # Registry path identified in STIG
    $RegistryValueName = "SmartCardAllowed"  # Value name identified in STIG
    $RegistryValue = @("*")  # Value(s) expected in STIG
    $RegistryType = "REG_SZ"  # Value type expected in STIG
    $SettingName = "Allow smart card authentication"  # GPO setting name identified in STIG
...
Function Get-V275972 {
    <#
    .DESCRIPTION
        Vuln ID    : V-275972
        STIG ID    : CVAD-WS-999999
        Rule ID    : SV-275972r1115780_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Virtual Apps and Desktop Workspace App running on the system must be a supported version.
        DiscussMD5 : 022238867743AEADCFA7389732C818E9
        CheckMD5   : 67C4524AFA77579F2955E9C3FC75ADF2
    ...
    foreach ($Item in $matchingSoftware) {
        $FindingDetails += "DisplayName:`t`t$($Item.DisplayName)" | Out-String
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8RatsfH5hdjo1
# rrsYfS8g5BBh0Pb0VeUiQHZpzXoz8KCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCAJW8Qo7sffMwa+jA1ddf8anWK6UN3hWLlhxFq+O58BbjANBgkqhkiG9w0BAQEF
# AASCAQAS9s64Rtdta/wtImKGtESv/foIFjOWX1sjlTS3BbP8ATBATxg3VRg4PgQl
# /HVaFHIpYf6Zykqd/GWohZvgkaRT67uzbrjRgtudBi0Ae3tRFpc3HLyTQQxXDAiz
# DjsJQLrsM8RCDaH31hlXk6DrKLzBIATqqGrTIkg62JsCa4JgukvcdEPZf0AlVJWS
# I68NVGo8dZY0yyNj2G6lVe+N49TF9qZLA5LR8e9hdnM67jmKEoI/iu9XA7ilbhJL
# R/ld91AtJxZJHFyazB5phSMFNhNAOcdtM9p3jbc0ATJLXWikZMoCHsyqU7XJSQKN
# d9UbRWD4VD0MICTHKjfWpwDrJzYUoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTEyOVowLwYJKoZIhvcNAQkEMSIEIH+VMnsyPv+0Cv+6Mge2q62GqLdX
# +iQHnBYM/BouEYWWMA0GCSqGSIb3DQEBAQUABIICAEpirTVitbA+ign734XHE1Gu
# TuhE/5zwGatj3COKg67dj8SXS5DD1xvyUyiwHcPp9AmnjFeNgFzZIPuJyhSlg+Fd
# nhXWYDEedLYICtBGQsi0zmxmPAkp7Qzqnim+wu4UCUdpLXiGOMP3ZkuQlpaJ2CJP
# MD0Xqbg35ELfREiyM9vn6APGhi1xDF8KkxU3lgumeQGoARpReL9JxL/ACcvikIU/
# XCC/8276GnAWtn+1Rs2FTr2LnkqdUgNPPcYL0Zt60bt+B4GMmj6I7RBc9gmEUV2p
# fsBvegcM2O8g+VWv/pTWoSDTjSdnn+v4OsNsGb1cqULWxEVR4U1cCx8IqmEhCOzQ
# uM+EBFtTyw7E9E7D7K3iUnCbP7dHCko+sTLvtjMWIjseeDmzkJPbpWqtLCXaROVW
# Q8uBIue3pQXpHg9DhkcygC+eeJ+dngEJRn4kD+WzASz2TQ2f0DRI82/1nx22mE+O
# Ru7qN/U5dFjjMSbRjuq6idgh0wQggNN3UatFKqIjkqw7jKKt/3rLVF3/XWoBUxUP
# uyK1N91DfMkezPwxdG8g0DG1R3iuvGAaCIdIqMlPmiztN+cKD1bowZcVvSP3VqbX
# dbUxpxD31rglX8DnwYQ97M92VXGxLkMjC98jZch4GnlCo6h/P248YQCKVyajmvoK
# RpA9BhlXfjZt5RTjq7MV
