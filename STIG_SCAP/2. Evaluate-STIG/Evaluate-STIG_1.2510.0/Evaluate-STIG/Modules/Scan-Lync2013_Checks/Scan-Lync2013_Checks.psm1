...
Function Get-V242503 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242503
        STIG ID    : DTOO420
        Rule ID    : SV-242503r961026_rule
        CCI ID     : CCI-000196
        Rule Name  : SRG-APP-000171
        Rule Title : The ability of Lync to store user passwords must be disabled.
        DiscussMD5 : 3D14645075EA1A5D138F886B8A6892FD
        CheckMD5   : AB34183944BE2FAFEBECD6C7BD9A3AAA
        FixMD5     : FE7B634E8D2D7CF5A7684647DB97E4D7
    #>
...
Function Get-V242504 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242504
        STIG ID    : DTOO421
        Rule ID    : SV-242504r961110_rule
        CCI ID     : CCI-001184
        Rule Name  : SRG-APP-000219
        Rule Title : Session Initiation Protocol (SIP) security mode must be configured.
        DiscussMD5 : 9DC5E435997A86E8E48AD6A193A132AD
        CheckMD5   : 21D095B416B544D76C042D288894B5DD
        FixMD5     : 367A1D72597CF5E69A2BFA1A82BC77FF
    #>
...
Function Get-V242505 {
    <#
    .DESCRIPTION
        Vuln ID    : V-242505
        STIG ID    : DTOO422
        Rule ID    : SV-242505r961110_rule
        CCI ID     : CCI-001184
        Rule Name  : SRG-APP-000219
        ...
        DiscussMD5 : 96461C442E4A2D8CBFBC2A1E3642B569
        CheckMD5   : 577A319E046F710E9D49D4DEE06D863C
        FixMD5     : 10C18E624525F4E671599704671651DC
    #>
...
Function Get-V265903 {
    <#
    .DESCRIPTION
        Vuln ID    : V-265903
        STIG ID    : DTOO999-Lync13
        Rule ID    : SV-265903r999913_rule
        CCI ID     : CCI-002605
        Rule Name  : SRG-APP-000456
        Rule Title : The version of Lync running on the system must be a supported version.
        DiscussMD5 : 117ECC7EE34DF6F898C147FBFE6F17EA
        CheckMD5   : 2C1DADCDC7063DC6386515F228119469
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAoJHzeR1UYuhMA
# 4FBcLDeug2tMkNajEjmnhXlm0c4rJaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCB4tNQSK2CQDytXrTvsvYni7hjBwrME+x4P/d3w2/py9jANBgkqhkiG9w0BAQEF
# AASCAQBjrmWe61EZS09EbxrYiZ5hkG8Aen8FPu878/zrbvi1xoqZsXzvD/yKdGht
# ve/D9ojeGoe3ssbcqsqsoXfH98jUkTVkHOR8bb+y64FBXVTOQeA3Q9zXcB0CoAvr
# IS5Sje3sglVKyzRqdFmPmh2yMjvfCWhSOp3HmNbZni27CT7ulhS9wvKYTqio5UO/
# 7ii4LPqXwTxyRCZT1H936wGlS+FP+rg2avnBZoqWZGu6ssxl2yVceEHwyWRK8SIG
# 2XGrtdgp+NqvhMolZR0YgMzBwbsolRmBDaGLSZ81GeM+s/sQBiK+z3iSn5lKF86z
# v7BkieEURVt+pgQdp9AsMx065buLoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTE0MFowLwYJKoZIhvcNAQkEMSIEIP2uI5K6hBL6+CeZW+RBSIHLwSsf
# WVSwFo22jgsrXHyGMA0GCSqGSIb3DQEBAQUABIICACXks+0UkfxjdJ/nKooJ8vHY
# sl1k3gMbx13f1Ts5yz1XaofleSB9jQIgwTwBjyAEVCSNdjrcHBxu2msriJjcguRr
# qCSetjjPqKP5BKZFINJN1i4MhlEcBMzxyU/ECtbuncpYI3j/z9we1UeAwBrXddOO
# IoEZZSF+wE1qSaqEuJNuyRkLvhkVlSS0+Tj0R7vfgA2WR7J1m3iVriGVufrO0svt
# AjESGh0OGwsAeM5E2lpVXbb9UDR0zn1ts5m77zC7s/Drp89R44/zIcO6RBL4aLNK
# ryiCA+NgFcboDCzjN4RiXd4v7GRZareF+WY0IY1wRUHhXv8efoNuniFomAdXp1DK
# puDMrkMbsE6qSEp5bh8eCi12ARqdHISJEsSyP9OhDnsMt9YoF5MPy6bxtMxVWqNc
# O8Cyj/T+SfVshdqarylHiIFnhnndOswxmVKE203DfAAUUQE2LM8D4YovL4EvlQti
# LJxbTExQ/hy5OXcZAOcmNCfK+dYx6REd338qJCXCJp9YShEiUg82+jPDbK4CrwDO
# 4D2gtW3mja5jXewHfFbJ30G3DDlH4XKQ3CrPlZ4OXAwCpennA8+TXkr965gWWxBM
# Y/S9Iw+xQWL/34ZSQdqZS4We2DvjD6NFQr4mQDILQIiLn7cej9958SlCAI3HQ6py
# jPdfeKsp+tJgEN40D08z
