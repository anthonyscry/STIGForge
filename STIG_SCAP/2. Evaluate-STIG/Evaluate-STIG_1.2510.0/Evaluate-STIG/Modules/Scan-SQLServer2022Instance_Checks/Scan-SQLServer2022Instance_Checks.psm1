...
Function Get-V271263 {
    ...
    $FindingDetails = "The server's maximum connection limit is set as follows:`n`n"
    $FindingDetails += "Current limit: $iRunConns"
    $FindingDetails += "Configured limit: $iConfigConns"
...
Function Get-V271265 {
    ...
    Else {
        ...
        $FindingDetails += "Authention mode is Windows Mixed. Verify the following SQL accounts are documented and approved by the ISSO/ISSM:`n$($ress | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271266 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271266r1117167_rule
        CCI ID     : CCI-000213
...
Function Get-V271268 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271268r1136917_rule
        CCI ID     : CCI-000166
        Rule Name  : SRG-APP-000080-DB-000063
        ...
        CheckMD5   : 99B8F653483890A7C1BB414B549A3AA9
    ...
    #---=== Begin Custom Code ===---#
    # Updated IsClustered permission list as revised in STIG version Y25M10. Ken Row, 12/2/25, Issue 2635
    ...
    ElseIf ($stat.IsClustered) {
        $permlist = "'CONNECT SQL', 'VIEW SERVER STATE', 'VIEW ANY DATABASE', 'VIEW SERVER PERFORMANCE STATE', 'VIEW SERVER SECURITY STATE'"
    }
    Else {
...
Function Get-V271271 {
    ...
    if ($res) {
        #$Status = 'Open'
        $FindingDetails += "Ensure the following have been authorized by the ISSM to create and/or maintain audit definitions:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271290 {
    ...
    "
    if ($res) {
        $FindingDetails = "The following database names match known sample/demo SQL databases:`n$($res | Format-Table | Out-String | remove-trailingspaces)"
    }
    else {
...
Function Get-V271291 {
    ...
    Else {
        $Status = "Not_Reviewed"
        $FindingDetails = "Compare system documentation of required components this list of what's installed:`n`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271292 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with Replication Xps enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271293 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with External Scripts Enabled enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271295 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with Remote Data Archive enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271296 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with Allow Polybase Export enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271297 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with Hadoop Connectivity enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271298 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with Remote Access enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271300 {
    ...
    if ($res) {
        $Status = 'Open'
        $FindingDetails += "Ensure the SSP documents the following Non-Standard extended stored procedures as required:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    else {
        $Status = "NotAFinding"
...
Function Get-V271301 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with CLR Enabled enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271302 {
    ...
    if ($res) {
        ...
        $FindingDetails += "SQL is $sState with XP_CmdShell enabled:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)" +
...
Function Get-V271304 {
    ...
    "
    if ($res) {
        $FindingDetails = "Verify the following enabled protocols are documented and authorized:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271305 {
    ...
    if ($res) {
        ...
        $FindingDetails += "by either the system or the application:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    ...
    if ($res) {
        $Status = "Open"
        $FindingDetails = "Additionally, the following computer accounts were found, which, per the STIG, is a finding:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
For the record, Eval-STIG notes the following encryption states for user databases:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    #---=== End Custom Code ===---#
...
Function Get-V271327 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271327r1117173_rule
        CCI ID     : CCI-001090
    ...
    if ($res) {
        $FindingDetails += "Confirm that IFI is documented as required for this account:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271328 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271328r1117173_rule
        CCI ID     : CCI-001090
        Rule Name  : SRG-APP-000243-DB-000373
    ...
    if ($res) {
        ...
        $FindingDetails += "`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    else {
        $Status = 'Open'
...
Function Get-V271329 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271329r1117173_rule
        CCI ID     : CCI-001090
    ...
    if ($arrDetails.Count -eq 0) {
        ...
        $FindingDetails += "Eval-STIG found the following directories and privileges:`n$(
          $arrDetails | Format-Table -property Type, Principal, Privileges, Check -AutoSize -GroupBy Directory | Out-String | Remove-TrailingSpaces
        )"
        if (!$fFinding) {
            $Status = "NotAFinding"
        }
...
Function Get-V271342 {
    ...
    if ($res) {
        #$Status = 'Open'
        $FindingDetails += "Ensure the following have been documented as authorized for use by external processes:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    else {
        $Status = "NotAFinding"
        $FindingDetails = "No results were returned by the check queries."
...
Function Get-V271349 {
    ...
    if ($res) {
        $FindingDetails += "Ensure the following have been documented as authorized to be in the server's local Administrators group:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    else {
        $Status = "NotAFinding"
        $FindingDetails = "No results were returned by the check queries."
...
Function Get-V271350 {
    ...
    "
    if ($res) {
        $FindingDetails += "Ensure the following have been documented as authorized to control the server:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    ...
    if ($res) {
        $FindingDetails += "Ensure the following have been documented as authorized to administer the server:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271358 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271358r1117179_rule
        CCI ID     : CCI-002530
    ...
    if ($res) {
        $Status = 'Open'
        $FindingDetails += "The following services are configured with the same service account:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }

    $res = Get-ISQL -ServerInstance $Instance -Database $Database "select servicename, service_account from sys.dm_server_services"
    $FindingDetails += "Verify that the following accounts are all documented and authorized:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
...
Function Get-V271359 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271359r1117179_rule
        CCI ID     : CCI-002530
        Rule Name  : SRG-APP-000431-DB-000388
...
Function Get-V271364 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271364r1117151_rule
        CCI ID     : CCI-002605
    ...
    $FindingDetails = "Verify Security-relevant software updates to SQL Server are installed within the time period directed by an authoritative source (e.g. IAVM, CTOs, DTMs, and STIGs):`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    #---=== End Custom Code ===---#
...
Function Get-V271365 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-271365r1117151_rule
        CCI ID     : CCI-003376
    ...
    $FindingDetails += "`n`nThe following SQL-related products are installed: $($productlist | Format-Table | Out-String | remove-trailingspaces)"
...
Function Get-V271370 {
    ...
    "
    If ($res) {
        $FindingDetails += "`nThe SCHEMA_OBJECT_CHANGE_GROUP is included in the server audit specification.`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    Else {
        $Compliant = $False
        $FindingDetails = "`nThe SCHEMA_OBJECT_CHANGE_GROUP was not returned in an active audit.`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
...
Function Get-V271375 {
    ...
    if ($resa) {
        ...
        $FindingDetails += "`n`nHere are the query results:`n$($res,$res2 | Format-Table | Out-String | Remove-TrailingSpaces)"
    } else {
        $Status = "Open"
...
Function Get-V271381 {
    ...
    if ($res) {
        $FindingDetails += "Inspect the following filters to ensure direct accesses to the databases are not being excluded:`n$($res | Format-Table | Out-String -Width 160 | Remove-TrailingSpaces)"
    }
    else {
        $Status = "NotAFinding"
        $FindingDetails = "No results were returned by the check queries."
...
Function Get-V271388 {
    ...
    $FindingDetails += "`n`nThis is the Windows Service information for the telemetry service:$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
...
Function Get-V274444 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-274444r1117167_rule
        CCI ID     : CCI-000213
        Rule Name  : SRG-APP-000033-DB-000084
...
Function Get-V274449 {
    ...
    if ($res) {
        $Status = 'Open'
        $FindingDetails += "Has the accessing of the registry via extended stored procedures been documented as required and authorized?:`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
    }
    else {
        $Status = "NotAFinding"
        $FindingDetails = "No results were returned by the check query."
...
Function Get-V274450 {
    ...
    $FindingDetails += "`n`n$($res | Format-Table | Out-String | Remove-TrailingSpaces)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB45GYsEBp1/WJp
# v8h60aISFFi5/56i8Br31GsabvBRdaCCHiQwggUqMIIEEqADAgECAgMTYdUwDQYJ
...
# BCDeXwUNJggneDE6OguqGN5iELAlqJcw1c5fPddLhXEJSzANBgkqhkiG9w0BAQEF
# AASCAQB7qzbxZYPQ1YeMrd9nlj9d2Ll/7zePpia2AuGh9H67gT95R4mvn6sjz3M4
# +l1J0TCCxX2lsAZxjKJ1RaY5SympFs6aKA4Oo/VE9rHVmWjZkYKHOIoZg6u6Cymo
# 6HSUtbw3oUu2ht2A9mu7TNy4VL1umJ7H+EY0dGfGocDGo3b0pDUZFQmkQqYNjWhX
# CRSySSD5A5G+2UsiPnlkW2iK0VX9vDHMbeDrCptzKCYHDHesbfhCteG6fVTA2fIj
# JwUJ1lGVWMLbKRl1wMzy0FMkZzg/u9n4PohznzT2CzLOw58m1Y0M5Go7eydEmhiP
# 1DKkaVg8MFZtjXDkz2SJJL1r6aGUoYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMP
# AgEBMH0waTELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEw
# PwYDVQQDEzhEaWdpQ2VydCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2
# IFNIQTI1NiAyMDI1IENBMQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MTIxMTE4NTIxN1owLwYJKoZIhvcNAQkEMSIEIJQGmUqJFG5c422nwxDHzQnDs0We
# Sy5/zfdkcleFBZOkMA0GCSqGSIb3DQEBAQUABIICADEoTBolom0dfDNMcmaUifvZ
# WL8rvcT4J6mvLDUyw1fmElhBGEDMKOhroBZK1Ce756hsvNw+HgO3iPZ+O3zS6PuD
# oDHuIz6SXU9/hfNkJiXMKdoytbo9wfM9E6SYmuooi9UMWnFbq/Db+qWRD5lsjb0u
# cqOnGBKxb0vwU/Td1ZOAQBmfxk1JJHOUPpiEZ2fF87g1A6z2YLvR7ikVloA0Ed5p
# 1Va4ttjf+nlR5wln41QdmSzsM1L6WYXMGUEzfWo5c/2tIng5NIMWcIYikP0RHX1R
# e2UvBwz1bJ5xAtWNPfsd4Y/TzrgAshzIyPnJwIddXl5k/kbszGFVbCi0EVUuM3Jp
# I0zUSZffW7IfvomMA8r8KmzzdaWb7yLfm/GbqLLz3GngOBWMPCCkyNkddhmdeIjt
# 2cDArktXhuhy7gdLpg9qH0o2Eoob+Fgrz/OUvqtiSVCEYE/sVAGCbQrBJWl0d71m
# +/Xjd5ObbZt5pe8wS5lhokF6zTTk6+dgaXd5ESSNkthJFvpaLPKGjEZwls3WYdm7
# yTNKA9abvkKhjX8lz0QuHnA8/7CiCYwTcE2joYNM1ny52J0TgN0Jasilf87NkrEU
# Na9CDTSUeu87vMcEzOKHZ/+DQX/GSEii3D0LoozjDQ2nElHYp20VGFKiKsMDeoom
# WQTOGOBvNwSar/zWxAZc
