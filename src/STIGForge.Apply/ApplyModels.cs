...
public sealed class ApplyRequest
{
   ...
   /// <summary>Path to completed OrgSettings XML for PowerSTIG organizational values.
   /// Generated by the pre-flight dialog from user-provided answers.</summary>
   public string? OrgSettingsPath { get; set; }
