...
This archive captures the active v1.1 requirements set at closeout time. The live `.planning/REQUIREMENTS.md` file has been removed after milestone completion.
