...
- Requirement source (historical): `.planning/milestones/v1.1-REQUIREMENTS.md`
- Closeout status: archived in `.planning/milestones/v1.1-REQUIREMENTS.md` and `.planning/milestones/v1.1-MILESTONE-AUDIT.md`
