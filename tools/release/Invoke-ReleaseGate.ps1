...
try {
  ...
  $upgradeRebaseDiffCommand = "dotnet test tests/STIGForge.UnitTests/STIGForge.UnitTests.csproj --configuration $Configuration --framework net8.0 --nologo --no-build --filter 'FullyQualifiedName~BaselineDiffServiceTests' --results-directory '$upgradeRebaseResultsRoot'"
  $upgradeRebaseOverlayCommand = "dotnet test tests/STIGForge.UnitTests/STIGForge.UnitTests.csproj --configuration $Configuration --framework net8.0 --nologo --no-build --filter 'FullyQualifiedName~OverlayRebaseServiceTests' --results-directory '$upgradeRebaseResultsRoot'"
