...
try {
  ...
  $upgradeRebaseParityCommand = "dotnet test tests/STIGForge.UnitTests/STIGForge.UnitTests.csproj --configuration $Configuration --framework net8.0-windows --nologo --no-build --filter 'FullyQualifiedName~BundleMissionSummaryServiceTests' --results-directory '$upgradeRebaseResultsRoot'"
